		...
		<Overview moduleId={ moduleId } section={ ( val ) => setSection( val ) } noIntegrate>
			{
				section === 'about' &&
				<section>
					<p>Many websites struggle with maintaining or improving their visibility online. Luckily, URLsLab’s SEO Insights tool is here to help. It improves your online visibility by identifying relevant search terms for your industry, organizing them for content creation, and providing competitor insights.</p>
					<p>Analyzing and utilizing your SERP data is one of the most powerful features of the SEO Insights module. Paired with the AI Content module, it can help you automatically generate articles based on certain keywords. The functionality allows you to enhance your online visibility by directly utilizing the insights you have gained.</p>
					<p>Furthermore, the SEO Insights module allows you to import data from the Google Search Console and compare it with your competitors. This module also groups various keywords with similar relevance and meaning according to SERP. To ensure that the module suits your website’s needs, you can customize and configure its functionalities in the Settings tab.</p>
					<p>Implementing the SEO Insights module can lead to more data-driven decision-making processes due to its dashboards filled with valuable information. Additionally, employing this module gives you a competitive advantage, improves your online visibility, and helps attract wider audiences.</p>
				</section>
			}
			{
				section === 'faq' &&
					<section>
						...
						<h4>How does the SEO Insights module help in improving my website's ranking?</h4>
