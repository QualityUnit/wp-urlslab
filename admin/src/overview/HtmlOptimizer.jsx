		...
		<Overview moduleId={ moduleId } section={ ( val ) => setSection( val ) } noIntegrate>
			{
				...
				<section>
					...
					<p>Inline CSS is a way to add styling directly to an HTML element, eliminating the need to make additional requests to external CSS files, thus improving page speed. The Optimisations module allows you to overview and process CSS and JavaScript files from one convenient interface.</p>
					<p>Using URLsLab’s Optimisations allows you to optimize such files even without extensive coding skills, making it an accessible solution for website owners and SEO professionals across the board. Using this module results in improved website performance, enhanced SEO rankings, and ultimately better user experience.</p>
				</section>
			}
			{
				section === 'faq' &&
					<section>
						<h4>How does the Optimisations module improve website performance?</h4>
						<p>By removing content-blocker requests, the Optimisations module assists in boosting your website performance.</p>
						<h4>Can I use the Optimisations module on a large website?</h4>
