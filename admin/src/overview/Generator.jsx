	...
	return (
		<Overview moduleId={ moduleId } section={ ( val ) => setSection( val ) }>
			...
			}
			{
				section === 'faq' &&
					<section>
						<h4>How can I integrate the AI Content into my website?</h4>
						...
						<h4>Does AI Content offer a mass content creation functionality?</h4>
						<p>Yes, the AI Content module allows users to generate large amounts of uniform content across multiple web pages, saving valuable time and energy. With its customization capabilities, the module produces content that isn’t repetitive but still encompasses your brand voice.</p>
						<h4>Can the AI Content create content for any industry or niche?</h4>
						<p>Yes, it can. The AI Content module creates content based on the prompts you provide. This way it can write expert articles regardless of your industry or niche.</p>
					</section>
			}
		</Overview>
	);
