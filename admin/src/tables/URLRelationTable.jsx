...
const title = __( 'Add New Related Article' , 'wp-urlslab' );
...
const header = {
	...
	pos: __( 'Position' , 'wp-urlslab' ),
	is_locked: __( 'Locked' , 'wp-urlslab' ),
	created_date: __( 'Updated' , 'wp-urlslab' ),
};
	...
	return (
		<>
			<DescriptionBox	title={ __( 'About this table' , 'wp-urlslab' ) } tableSlug={ slug } isMainTableDescription>
				{ __( 'The table illustrates the associations between URLs on your website. The plugin can automatically load these connections, a paid feature, or you can configure them manually. These data sets are predominantly used by the plugin to display the Related Articles widget. This widget can either be included automatically on all your pages, as seen in the Settings tab, or added individually to each page or template through a shortcode.' , 'wp-urlslab' ) }
			</DescriptionBox>
			<ModuleViewHeaderBottom />
