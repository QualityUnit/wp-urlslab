		...
		if ( origCell.kw_usage_count > 0 ) {
			setOptions( [ {
				detailsOptions: {
					...
					slug, url: `${ origCell.kw_id }/${ origCell.dest_url_id }`, showKeys: [ { name: [ 'link_type', __( 'Type', 'wp-urlslab' ) ], size: 30, values: { U: __( 'Urlslab', 'wp-urlslab' ), E: __( 'Editor', 'wp-urlslab' ) } }, { name: [ 'url_name', __( 'URL', 'wp-urlslab' ) ] } ], listId: 'url_id',
					counter,
				},
			} ] );
		}
