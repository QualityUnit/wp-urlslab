...
const header = {
	groupBucketTitle: __( 'Date', 'wp-urlslab' ),
	installationId: __( 'Installation ID', 'wp-urlslab' ),
	creditType: __( 'Type', 'wp-urlslab' ),
	events: __( 'Count', 'wp-urlslab' ),
	credits: __( 'Usage', 'wp-urlslab' ),
};
	...
	return (
		<>
			<DescriptionBox	title={ __( 'About this table', 'wp-urlslab' ) } tableSlug={ slug } isMainTableDescription>
				{ __( 'The table displays the charges deducted from your credit balance, categorized by transaction type and date. These charges are associated with tasks run by your API key. If multiple WordPress installations use the same API key, the table will also show the costs generated by all installations.', 'wp-urlslab' ) }
			</DescriptionBox>
