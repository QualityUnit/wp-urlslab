	...
	return (
		<>
			<DescriptionBox	title={ __( 'Learn more...' ) } isMainTableDescription>
				{ __( "The table displays the costs deducted from your credit balance, grouped by transaction type and date. These costs are associated with tasks run by your API key. If multiple Wordpress installations utilize the same API key, the table will also show the costs generated by all installations." ) }
			</DescriptionBox>
			<ModuleViewHeaderBottom
				noFiltering
				noCount
