		...
		<div className="urlslab-panel-wrap urlslab-panel-modal fadeInto">
			<div className="urlslab-panel">
				<div className="urlslab-panel-header">
					<h3>{ __( 'Delete All Filtered?', 'wp-urlslab' ) }</h3>
					<button className="urlslab-panel-close" onClick={ hidePanel }>
						<CloseIcon />
					</button>
				</div>
				<p>{ __( 'Are you sure you want to delete all filtered rows? Deleting rows will remove them from all modules where this table occurs.', 'wp-urlslab' ) }</p>
				...
				<div className="mt-l">
					...
					<div className="flex">
						...
						<Button
							...
							sx={ { ml: 1 } }
						>
							{ __( 'Delete All Filtered', 'wp-urlslab' ) }
						</Button>
					</div>
				</div>
			</div>
