...
import { editRole } from '../api/role/editRole';
import { fetchRolesList } from '../api/role/fetchRolesList';
import { fetchCapabilitiesList } from '../api/fetchCapabilitiesList';
import { fetchUsers } from '../api/fetchUsers';
import { roleCapabilityUpdater } from '../api/roleCapabilityUpdater';
        ...
        <ul className="urlslab-mainmenu-menu">
          ...
          <li className="urlslab-mainmenu-item submenu">
            <ul className="urlslab-mainmenu-submenu">
              ...
              <li key="urlslab-roles" className={`urlslab-mainmenu-item ${activator('urlslab-roles')}`}>
                <button type="button" className="urlslab-mainmenu-btn" onClick={() => setActivePage('urlslab-roles')}>
                  <span>{__('Roles')}</span>
                </button>
              </li>
