	...
	return (
		...
		>
			...
			<div className={ `${ isFloating ? 'urlslab-panel-content' : '' }` }>
				...
				{
					aiGeneratorConfig.keywordsList.length > 0 && <div className="urlslab-panel-content__item">
...

				{
					aiGeneratorConfig.dataSource && aiGeneratorConfig.dataSource === 'URL_CONTEXT' && (
						<div className={ `${ isFloating ? 'urlslab-panel-content__item' : '' } mb-l` }>
							<div className="urlslab-panel-content__item-container">
								<EditableList
...

				{
					aiGeneratorConfig.dataSource && aiGeneratorConfig.dataSource === 'SERP_CONTEXT' && (
						<div className="urlslab-panel-content__item">
							{
				...
				<div className={ `${ isFloating ? 'urlslab-panel-content__item' : '' } mb-l` }>
					<div className="urlslab-panel-content__item-selector">
						<SingleSelectMenu
			...
			<div className={ `${ closeBtn ? 'flex' : '' }` }>
				{ closeBtn &&
					<Button className="ma-left mr-s" onClick={ handleClose }>{ __( 'Close' ) }</Button>
				}
