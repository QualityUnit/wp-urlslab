  ...
  if (null !== f) {
    ...
    do {
      ...
      if ((d & r2) === r2) {
        ...
        y2 = { eventTime: y2, lane: r2, tag: h.tag, payload: h.payload, callback: h.callback, next: null }, null === m ? (l2 = m = y2, k = q2) : m = m.next = y2, g |= r2;
      h = h.next;
      if (null === h)
...
function vh(a) {
  ...
  function n2(e2, g2, h2, k2) {
    ...
    if (null === u2) {
      for (; w2 < h2.length; w2++)
        u2 = q2(e2, h2[w2], k2), null !== u2 && (g2 = f(u2, g2, w2), null === m2 ? l3 = u2 : m2.sibling = u2, m2 = u2);
      I && tg(e2, w2);
      return l3;
    }
    for (u2 = d(e2, u2); w2 < h2.length; w2++)
      x2 = y2(u2, e2, w2, h2[w2], k2), null !== x2 && (a && null !== x2.alternate && u2.delete(null === x2.key ? w2 : x2.key), g2 = f(x2, g2, w2), null === m2 ? l3 = x2 : m2.sibling = x2, m2 = x2);
  ...
  function t2(e2, g2, h2, k2) {
    ...
    for (m2 = d(e2, m2); !n3.done; w2++, n3 = h2.next())
      n3 = y2(m2, e2, w2, n3.value, k2), null !== n3 && (a && null !== n3.alternate && m2.delete(null === n3.key ? w2 : n3.key), g2 = f(n3, g2, w2), null === u2 ? l3 = n3 : u2.sibling = n3, u2 = n3);
...
function ij(a, b, c, d, e) {
  ...
  if (null === b.stateNode)
    ...
    (m = "function" === typeof y2 || "function" === typeof g.getSnapshotBeforeUpdate) || "function" !== typeof g.UNSAFE_componentWillReceiveProps && "function" !== typeof g.componentWillReceiveProps || (h !== q2 || r2 !== k) && qh(b, g, d, k);
    $g = false;
    r2 = b.memoizedState;
    g.state = r2;
    gh(b, d, g, e);
...
const style = "";
function App() {
  return /* @__PURE__ */ React.createElement("div", { className: "" }, "divko");
}
console.log("assistants app");
reactDomExports.createRoot(document.getElementById("urlslab-ai-content-assistent-root")).render(
