...
function MainMenu({ activeModule, modules, activePage, module }) {
  ...
  return /* @__PURE__ */ React.createElement("nav", { className: `urlslab-mainmenu`, ref: mainmenu }, /* @__PURE__ */ React.createElement(
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: "urlslab-mainmenu-main flex" }, /* @__PURE__ */ React.createElement("ul", { className: "urlslab-mainmenu-icons" }, /* @__PURE__ */ React.createElement("li", { className: `urlslab-mainmenu-item ${activator("urlslab-modules")}` }, /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "urlslab-mainmenu-btn has-icon",
      onClick: () => handleActive("urlslab-modules")
    },
    /* @__PURE__ */ React.createElement(SvgMenuIconModules, { className: "" }),
    /* @__PURE__ */ React.createElement("span", null, __("Modules"))
  )), /* @__PURE__ */ React.createElement("li", { className: `urlslab-mainmenu-item settings ${activator("urlslab-settings")}` }, /* @__PURE__ */ React.createElement(
    "button",
    {
      className: "urlslab-mainmenu-btn has-icon",
  ...
  )), /* @__PURE__ */ React.createElement("li", { className: "urlslab-mainmenu-item" }, " ")), /* @__PURE__ */ React.createElement("ul", { className: "urlslab-mainmenu-menu" }, /* @__PURE__ */ React.createElement(
    "li",
    {
      key: "urlslab-modules",
  ...
  ), /* @__PURE__ */ React.createElement("li", { className: "urlslab-mainmenu-item submenu" }, /* @__PURE__ */ React.createElement("ul", { className: "urlslab-mainmenu-submenu", style: { "--activeModules": activeModules.length } }, modules.length ? modules.map((modul) => {
    ...
    /* @__PURE__ */ React.createElement("ul", { className: "urlslab-mainmenu-submenu" }, /* @__PURE__ */ React.createElement("li", { className: `urlslab-mainmenu-item` }, /* @__PURE__ */ React.createElement(
      "button",
      {
        type: "button",
        className: "urlslab-mainmenu-btn",
...
function DynamicModule({ modules, moduleId, activePage }) {
  const importPath = __variableDynamicImportRuntimeHelper(/* @__PURE__ */ Object.assign({ "../modules/CssOptimizer.jsx": () => __vitePreload(() => import("./assets/CssOptimizer-k19bbel4pvg.js"), true ? ["./assets/CssOptimizer-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/Generator.jsx": () => __vitePreload(() => import("./assets/Generator-k19bbel4pvg.js"), true ? ["./assets/Generator-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/ImageAltAttribute.jsx": () => __vitePreload(() => import("./assets/ImageAltAttribute-k19bbel4pvg.js"), true ? ["./assets/ImageAltAttribute-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/KeywordsLinks.jsx": () => __vitePreload(() => import("./assets/KeywordsLinks-k19bbel4pvg.js"), true ? ["./assets/KeywordsLinks-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/LazyLoading.jsx": () => __vitePreload(() => import("./assets/LazyLoading-k19bbel4pvg.js"), true ? ["./assets/LazyLoading-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/LinkEnhancer.jsx": () => __vitePreload(() => import("./assets/LinkEnhancer-k19bbel4pvg.js"), true ? ["./assets/LinkEnhancer-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/MediaOffloader.jsx": () => __vitePreload(() => import("./assets/MediaOffloader-k19bbel4pvg.js"), true ? ["./assets/MediaOffloader-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/MetaTag.jsx": () => __vitePreload(() => import("./assets/MetaTag-k19bbel4pvg.js"), true ? ["./assets/MetaTag-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/Modules.jsx": () => __vitePreload(() => import("./assets/Modules-k19bbel4pvg.js"), true ? ["./assets/Modules-k19bbel4pvg.js","./assets/Switch-k19bbel4pvg.js","./assets/Switch-k19bbel4pvg.css","./assets/api-exclamation-k19bbel4pvg.js","./assets/useMutation-k19bbel4pvg.js","./assets/Modules-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/Optimize.jsx": () => __vitePreload(() => import("./assets/Optimize-k19bbel4pvg.js"), true ? ["./assets/Optimize-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/Redirects.jsx": () => __vitePreload(() => import("./assets/Redirects-k19bbel4pvg.js"), true ? ["./assets/Redirects-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/RelatedResources.jsx": () => __vitePreload(() => import("./assets/RelatedResources-k19bbel4pvg.js"), true ? ["./assets/RelatedResources-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/Schedule.jsx": () => __vitePreload(() => import("./assets/Schedule-k19bbel4pvg.js"), true ? ["./assets/Schedule-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/Screenshot.jsx": () => __vitePreload(() => import("./assets/Screenshot-k19bbel4pvg.js"), true ? ["./assets/Screenshot-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/SearchAndReplace.jsx": () => __vitePreload(() => import("./assets/SearchAndReplace-k19bbel4pvg.js"), true ? ["./assets/SearchAndReplace-k19bbel4pvg.js","./assets/ModuleViewHeader-k19bbel4pvg.js","./assets/api-exclamation-k19bbel4pvg.js","./assets/_ModuleViewHeader-k19bbel4pvg.css"] : void 0, import.meta.url), "../modules/Settings.jsx": () => __vitePreload(() => import("./assets/Settings-k19bbel4pvg.js"), true ? ["./assets/Settings-k19bbel4pvg.js","./assets/datepicker-k19bbel4pvg.js","./assets/datepicker-k19bbel4pvg.css","./assets/Switch-k19bbel4pvg.js","./assets/Switch-k19bbel4pvg.css","./assets/useMutation-k19bbel4pvg.js","./assets/Settings-k19bbel4pvg.css"] : void 0, import.meta.url) }), `../modules/${renameModule(moduleId)}.jsx`);
  const Module = reactExports.lazy(() => importPath);
  return /* @__PURE__ */ React.createElement("div", { className: "urlslab-DynamicModule" }, /* @__PURE__ */ React.createElement(ErrorBoundary$1, null, /* @__PURE__ */ React.createElement(reactExports.Suspense, { fallback: /* @__PURE__ */ React.createElement(Loader, null) }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-DynamicModule-inn fadeInto" }, /* @__PURE__ */ React.createElement(
    Module,
    {
      modules,
...
const SvgUrlslabLogo = (props) => /* @__PURE__ */ reactExports.createElement("svg", { width: 123, height: 34, viewBox: "0 0 123 34", fill: "none", xmlns: "http://www.w3.org/2000/svg", ...props }, /* @__PURE__ */ reactExports.createElement("path", { d: "M49.92 24.108C48.78 24.108 47.772 23.874 46.896 23.406C46.032 22.938 45.354 22.296 44.862 21.48C44.37 20.652 44.124 19.722 44.124 18.69V11.382H46.842V18.564C46.842 19.152 46.974 19.68 47.238 20.148C47.514 20.616 47.88 20.988 48.336 21.264C48.804 21.54 49.332 21.678 49.92 21.678C50.52 21.678 51.054 21.54 51.522 21.264C52.002 20.988 52.38 20.616 52.656 20.148C52.932 19.68 53.07 19.152 53.07 18.564V11.382H55.698V18.69C55.698 19.722 55.452 20.652 54.96 21.48C54.468 22.296 53.784 22.938 52.908 23.406C52.044 23.874 51.048 24.108 49.92 24.108ZM60.1243 24V14.478H62.5723L62.6623 17.718L62.0863 17.34C62.2543 16.776 62.5243 16.26 62.8963 15.792C63.2803 15.324 63.7243 14.958 64.2283 14.694C64.7323 14.418 65.2603 14.28 65.8123 14.28C66.1243 14.28 66.4183 14.31 66.6943 14.37C66.9823 14.43 67.2163 14.508 67.3963 14.604L66.7123 17.376C66.5323 17.256 66.2923 17.16 65.9923 17.088C65.
 18.6876 12.9307 18.1462C13.125 17.9612 13.3845 17.8602 13.6529 17.8651C13.9212 17.8701 14.1768 17.9806 14.3642 18.1728C14.5516 18.3649 14.6557 18.6232 14.6539 18.8915C14.6522 19.1599 14.5448 19.4168 14.3549 19.6065C13.8157 20.1324 13.4455 20.8071 13.2917 21.5445C13.1378 22.2818 13.2073 23.0483 13.4912 23.7459C13.7751 24.4436 14.2605 25.0408 14.8855 25.4612C15.5105 25.8816 16.2466 26.1061 16.9998 26.1061C17.753 26.1061 18.4891 25.8816 19.1141 25.4612C19.739 25.0408 20.2245 24.4436 20.5084 23.7459C20.7923 23.0483 20.8617 22.2818 20.7079 21.5445C20.554 20.8071 20.1838 20.1324 19.6446 19.6065C19.4548 19.4168 19.3474 19.1599 19.3456 18.8915C19.3439 18.6232 19.448 18.3649 19.6354 18.1728C19.8228 17.9806 20.0784 17.8701 20.3467 17.8651C20.615 17.8602 20.8745 17.9612 21.0689 18.1462C21.6276 18.6876 22.0714 19.3361 22.3736 20.053C22.6758 20.7699 22.8303 21.5404 22.8277 22.3183ZM18.0198 20.7346V13.2662C18.0198 12.9957 17.9123 12.7362 17.721 12.5449C17.5297 12.3537 17.2703 12.2462 16.9998 12.2462C16.7293 12.2462 16.4698 12.3537 16.2785 12.5449C16.0872 12.7362 15.9798 12.9957 15.9798 13.2662V20.7346C15.9798 21.0052 16.0872 21.2646 16.2785 21.4559C16.4698 21.6472 16.7293 21.7546 16.9998 21.7546C17.2703 21.7546 17.5297 21.6472 17.721 21.4559C17.9123 21.2646 18.0198 21.0052 18.0198 20.7346ZM23.7294 8.40453C23.6398 8.24938 23.511 8.12055 23.3558 8.03102C23.2006 7.94149 23.0246 7.89442 22.8454 7.89453L11.1535 7.89453C10.9744 7.89442 10.7984 7.94146 10.6432 8.03094C10.4881 8.12042 10.3592 8.24917 10.2696 8.40425C10.18 8.55933 10.1328 8.73527 10.1328 8.91437C10.1328 9.09347 10.1799 9.26942 10.2695 9.42453L12.7593 13.7364C12.8946 13.9709 13.1174 14.142 13.3788 14.2121C13.6403 14.2823 13.9188 14.2457 14.1533 14.1104C14.3877 13.9752 14.5589 13.7523 14.629 13.4909C14.6991 13.2294 14.6626 12.9509 14.5273 12.7164L12.9198 9.93453H21.0798L19.4733 12.7164C19.4063 12.8325 19.3629 12.9606 19.3454 13.0935C19.328 13.2264 19.3369 13.3614 19.3716 13.4909C19.4063 13.6203 19.4662 13.7417 19.5478 13.848C19.6294 13.9543 19.7312 14.0434 19.8473 14.1104C19.9634 14.1774 20.0915 14.2208 20.2244 14.2383C20.3573 14.2557 20.4923 14.2468 20.6217 14.2121C20.7512 14.1774 20.8725 14.1175 20.9788 14.0359C21.0851 13.9543 21.1743 13.8525 21.2413 13.7364L23.7308 9.42487C23.8202 9.26965 23.8671 9.09363 23.8668 8.91452C23.8666 8.7354 23.8192 8.55951 23.7294 8.40453Z", fill: "white" })), /* @__PURE__ */ reactExports.createElement("defs", null, /* @__PURE__ */ reactExports.createElement("clipPath", { id: "clip0_483_16132" }, /* @__PURE__ */ reactExports.createElement("rect", { width: 34, height: 34, fill: "white" }))));
...
const SvgIconPlay = (props) => /* @__PURE__ */ reactExports.createElement("svg", { xmlns: "http://www.w3.org/2000/svg", width: "461.027954pt", height: "511.581165pt", viewBox: "0 0 461.027954 511.581165", preserveAspectRatio: "xMidYMid meet", ...props }, /* @__PURE__ */ reactExports.createElement("g", { transform: "translate(-25.500000,511.714172) rotate(-360.00) scale(0.095238,-0.095238)" }, /* @__PURE__ */ reactExports.createElement("path", { d: "M635 5362 c-174 -46 -298 -190 -349 -405 -17 -75 -18 -204 -18 -2269 0 -2065 1 -2194 18 -2269 67 -283 258 -437 516 -416 77 7 208 45 277 80 90 46 3678 2107 3743 2150 38 25 101 80 139 121 197 213 197 455 0 668 -38 41 -101 96 -139 121 -65 43 -3653 2104 -3743 2150 -131 67 -331 98 -444 69z" })));
function Header({ pageTitle }) {
  const { __ } = useI18n();
  const runCron = reactExports.useRef(false);
  const [cronRunning, setCronRun] = reactExports.useState(false);
  const [cronTasksResult, setCronTasks] = reactExports.useState([]);
  const [cronPanelActive, setCronPanelActive] = reactExports.useState(false);
  const [cronPanelError, setCronPanelError] = reactExports.useState(false);
  ...
  reactExports.useEffect(() => {
    if (cronTasksResult == null ? void 0 : cronTasksResult.length) {
      setCronPanelError(false);
  ...
  }, [cronPanelActive, cronTasksResult == null ? void 0 : cronTasksResult.length]);
  return /* @__PURE__ */ React.createElement(reactExports.Suspense, null, /* @__PURE__ */ React.createElement("header", { className: "urlslab-header" }, /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center" }, /* @__PURE__ */ React.createElement(SvgUrlslabLogo, { className: "urlslab-header-logo" }), /* @__PURE__ */ React.createElement("span", { className: "urlslab-header-slash" }, "/"), /* @__PURE__ */ React.createElement("h1", { className: "urlslab-header-title" }, pageTitle), /* @__PURE__ */ React.createElement(Button, { active: true, className: "pos-relative small ma-left", onClick: handleCronRunner }, !cronRunning ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SvgIconPlay, null), " ", __("Accelerate the Cron Execution")) : /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(Loader, { className: "mr-s noText small" }), " ", __("Stop Cron Execution")), /* @__PURE__ */ React.createElement(NotificationsPanel, { className: `${cronPanelError ? "error" : "dark"} wide`, active: cronTasksResult.length > 0 && cronPanelActive || cronPanelError }, !cronPanelError ? cronTasksResult.map((task) => /* @__PURE__ */ React.createElement("div", { className: "message", key: task.task }, task.description)) : /* @__PURE__ */ React.createElement("div", { className: "message", key: "cronError" }, __("Error has occured. Will run again in 1 min.")))))));
}
const style = "";
function App() {
  const { __ } = useI18n();
  ...
  )), /* @__PURE__ */ React.createElement("div", { className: "urlslab-app-main" }, /* @__PURE__ */ React.createElement(Header, { pageTitle: !pageTitle || pageTitle }), /* @__PURE__ */ React.createElement(
    DynamicModule,
    {
      modules: !fetchedModules || Object.values(fetchedModules),
      moduleId: module,
...
export {
  parseMutationArgs as A,
  Button as B,
  useSyncExternalStore as C,
  ...
  fetchData as h,
  commonjsGlobal as i,
  infiniteQueryBehavior as j,
  hasNextPage as k,
  langName as l,
  hasPreviousPage as m,
  parseQueryArgs as n,
  useBaseQuery as o,
  parseURL as p,
  get as q,
