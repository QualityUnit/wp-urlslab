...
async function cronAll(runCron, controller, cronTasks) {
  ...
  try {
    ...
    if (!(okResult == null ? void 0 : okResult.length)) {
      setInterval(() => cronAll(cronTasks), 5e3);
    }
  } catch {
    return false;
  }
