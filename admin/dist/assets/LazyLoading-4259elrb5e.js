import { R as React, u as useI18n, r as reactExports, _ as __vitePreload } from "../main-4259elrb5e.js";
import { M as ModuleViewHeader, O as Overview } from "./ModuleViewHeader-4259elrb5e.js";
import "./api-exclamation-4259elrb5e.js";
...
function LazyLoading({ moduleId }) {
  ...
  const SettingsModule = reactExports.lazy(() => __vitePreload(() => import("./Settings-4259elrb5e.js"), true ? ["./Settings-4259elrb5e.js","../main-4259elrb5e.js","./main.css","./datepicker-4259elrb5e.js","./datepicker-4259elrb5e.css","./Switch-4259elrb5e.js","./Switch-4259elrb5e.css","./useMutation-4259elrb5e.js","./Settings-4259elrb5e.css"] : void 0, import.meta.url));
  const YouTubeCacheTable = reactExports.lazy(() => __vitePreload(() => import("./YouTubeCacheTable-4259elrb5e.js"), true ? ["./YouTubeCacheTable-4259elrb5e.js","../main-4259elrb5e.js","./main.css","./useTableUpdater-4259elrb5e.js","./datepicker-4259elrb5e.js","./datepicker-4259elrb5e.css","./useMutation-4259elrb5e.js","./useTableUpdater-4259elrb5e.css"] : void 0, import.meta.url));
  const ContentCacheTable = reactExports.lazy(() => __vitePreload(() => import("./ContentCacheTable-4259elrb5e.js"), true ? ["./ContentCacheTable-4259elrb5e.js","../main-4259elrb5e.js","./main.css","./useTableUpdater-4259elrb5e.js","./datepicker-4259elrb5e.js","./datepicker-4259elrb5e.css","./useMutation-4259elrb5e.js","./useTableUpdater-4259elrb5e.css"] : void 0, import.meta.url));
