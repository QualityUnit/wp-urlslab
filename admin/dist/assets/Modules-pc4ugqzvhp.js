import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-pc4ugqzvhp.js";
import { S as Switch } from "./Switch-pc4ugqzvhp.js";
import { S as SvgApiExclamation } from "./api-exclamation-pc4ugqzvhp.js";
import { u as useMutation } from "./useMutation-pc4ugqzvhp.js";
const __vite_glob_0_0 = "" + new URL("optimize-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-pc4ugqzvhp.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-pc4ugqzvhp.png", import.meta.url).href;
