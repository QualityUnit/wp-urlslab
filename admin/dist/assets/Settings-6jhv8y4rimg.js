import { a as useQueryClient, r as reactExports, R as React, p as parseURL, B as Button, f as fetchData, c as setSettings, u as useI18n, d as useQuery, L as Loader, T as Tooltip, e as fetchSettings } from "../main-6jhv8y4rimg.js";
import { F as FilterMenu, S as SortMenu, H as Ht, I as InputField } from "./FilterMenu-6jhv8y4rimg.js";
import { S as Switch } from "./Switch-6jhv8y4rimg.js";
/* empty css                        */import { u as useMutation } from "./useMutation-6jhv8y4rimg.js";
function SettingsOption({ settingId, option, renderTooltip }) {
  ...
  const renderOption = () => {
    switch (type) {
      ...
      case "listbox":
        return /* @__PURE__ */ React.createElement(SortMenu, { key: id, className: "wide", name: id, items: possible_values, checkedId: value, autoClose: true, onChange: (selectedId) => handleChange.mutate(selectedId) }, title);
      case "multicheck":
        return /* @__PURE__ */ React.createElement(
          FilterMenu,
          {
