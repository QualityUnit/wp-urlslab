import { Q as QueryObserver, j as infiniteQueryBehavior, k as hasNextPage, m as hasPreviousPage, n as parseQueryArgs, o as useBaseQuery, R as React, r as reactExports, u as useI18n, f as fetchData, h as getParamsChar, L as Loader, a as useQueryClient, l as langName, q as get, t as update, B as Button, v as setData, i as commonjsGlobal, H as HeaderHeightContext, w as useResizeObserver, d as useQuery } from "../main-0spbnujwpri.js";
import { T as Tooltip, S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./Tooltip-0spbnujwpri.js";
import { u as useMutation } from "./useMutation-0spbnujwpri.js";
...
function TooltipSortingFiltering({ props: props2 }) {
  const { __ } = useI18n();
  const { isFetching, sortingColumn, filters } = props2;
  return isFetching && (sortingColumn || filters) ? /* @__PURE__ */ React.createElement(Tooltip, { center: true }, /* @__PURE__ */ React.createElement(Loader, null, __("Filtering & Sorting…"), /* @__PURE__ */ React.createElement("br", null), __("(might take a while)"))) : null;
}
const _RangeSlider = "";
...
const SvgIconCronRefresh = (props2) => /* @__PURE__ */ reactExports.createElement("svg", { width: "100%", height: "100%", viewBox: "0 0 24 24", xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", xmlSpace: "preserve", "xmlns:serif": "http://www.serif.com/", style: {
  fillRule: "evenodd",
  clipRule: "evenodd",
  strokeLinejoin: "round",
  strokeMiterlimit: 2
...
function TableFilterPanel({ props: props2, onEdit }) {
  ...
  const [date, setDate] = reactExports.useState(((_a = currentFilters[key]) == null ? void 0 : _a.val) ? new Date((_b = currentFilters[key]) == null ? void 0 : _b.val) : currentDate);
  const [startDate, setStartDate] = reactExports.useState(((_d = (_c = currentFilters[key]) == null ? void 0 : _c.val) == null ? void 0 : _d.min) ? new Date((_e = currentFilters[key]) == null ? void 0 : _e.val.min) : currentDate.setDate(currentDate.getDate() - 2));
  const [endDate, setEndDate] = reactExports.useState(((_g = (_f = currentFilters[key]) == null ? void 0 : _f.val) == null ? void 0 : _g.max) ? new Date((_h = currentFilters[key]) == null ? void 0 : _h.val.max) : currentDate);
  ...
  reactExports.useEffect(() => {
    ...
    if (state.filterObj.keyType === "number") {
      ...
      dispatch({ type: "setFilterVal", val: (_f2 = currentFilters[key]) == null ? void 0 : _f2.val });
    }
    if (state.filterObj.keyType === "menu") {
      dispatch({ type: "setFilterOp", op: ((_g2 = currentFilters[key]) == null ? void 0 : _g2.op) || "exactly" });
      dispatch({ type: "setFilterVal", val: ((_h2 = currentFilters[key]) == null ? void 0 : _h2.val) || Object.keys(filterValMenu)[0] });
    }
    if (state.filterObj.keyType === "boolean") {
      dispatch({ type: "setFilterOp", op: ((_i2 = currentFilters[key]) == null ? void 0 : _i2.op) || "exactly" });
      dispatch({ type: "setFilterVal", val: ((_j2 = currentFilters[key]) == null ? void 0 : _j2.val) || Object.keys(booleanTypes)[0] });
    }
    if (state.filterObj.keyType === "lang") {
      dispatch({ type: "setFilterOp", op: ((_k2 = currentFilters[key]) == null ? void 0 : _k2.op) || "exactly" });
      dispatch({ type: "setFilterVal", val: ((_l2 = currentFilters[key]) == null ? void 0 : _l2.val) || "all" });
    }
  ...
  return /* @__PURE__ */ React.createElement("div", { className: `urlslab-panel fadeInto urslab-TableFilter-panel pos-absolute` }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel-header urslab-TableFilter-panel-header" }, /* @__PURE__ */ React.createElement("strong", null, __("Edit filter"), key ? ` ${header[key]}` : "")), /* @__PURE__ */ React.createElement("div", { className: "flex mt-m mb-m flex-align-center" }, /* @__PURE__ */ React.createElement(
    SortMenu,
    {
      className: "mr-s",
  ...
  ), state.filterObj.keyType && (((_l = currentFilters[key]) == null ? void 0 : _l.op) || state.filterObj.filterOp) && /* @__PURE__ */ React.createElement(
    SortMenu,
    {
      className: "ml-s",
      key: ((_m = currentFilters[key]) == null ? void 0 : _m.op) || state.filterObj.filterOp,
    ...
    SortMenu,
    {
      ...
      defaultAccept: true,
      autoClose: true,
      checkedId: ((_p = currentFilters[key]) == null ? void 0 : _p.val) || Object.keys(filterValMenu)[0],
    ...
    SortMenu,
    {
      ...
      defaultAccept: true,
      autoClose: true,
      checkedId: ((_q = currentFilters[key]) == null ? void 0 : _q.val) || Object.keys(booleanTypes)[0],
      onChange: (val) => dispatch({ type: "setFilterVal", val })
    }
  ), state.filterObj.keyType === "string" && notBetween && /* @__PURE__ */ React.createElement(InputField, { liveUpdate: true, autoFocus: true, defaultValue: (_r = currentFilters[key]) == null ? void 0 : _r.val, placeholder: state.filterObj.filterOp === "IN" ? "enter ie. 0,10,15,20" : "Enter search term", onChange: (val) => dispatch({ type: "setFilterVal", val }) }), state.filterObj.keyType === "number" && notBetween && /* @__PURE__ */ React.createElement(InputField, { type: "number", liveUpdate: true, autoFocus: true, defaultValue: cellUnit === "kB" ? ((_s = currentFilters[key]) == null ? void 0 : _s.val) / 1024 : (_t = currentFilters[key]) == null ? void 0 : _t.val, placeholder: state.filterObj.filterOp === "IN" ? "enter ie. 0,10,15,20" : `Enter size ${cellUnit && "in " + cellUnit}`, onChange: (val) => dispatch({ type: "setFilterVal", val: cellUnit === "kB" ? val * 1024 : val }) }), state.filterObj.keyType === "date" && notBetween && // Datepicker not between
  ...
  /* @__PURE__ */ React.createElement("div", { className: "urlslab-datetime-range" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-inputField-datetime" }, /* @__PURE__ */ React.createElement(
    ...
    RangeInputs,
    {
      liveUpdate: true,
      unit: cellUnit,
      defaultMin: (_u = currentFilters[key]) == null ? void 0 : _u.val.min,
      defaultMax: (_v = currentFilters[key]) == null ? void 0 : _v.val.max,
      onChange: (val) => dispatch({ type: "setFilterVal", val })
    }
...
function TableFilter({ props: props2, onEdit, onRemove }) {
  const { __ } = useI18n();
  const { currentFilters, state, slug, header, initialRow } = props2;
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center flex-wrap" }, header && (activeFilters == null ? void 0 : activeFilters.map((key, index) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex" }, header[key], ": ", /* @__PURE__ */ React.createElement("span", { className: "regular flex flex-align-center" }, /* @__PURE__ */ React.createElement("span", { className: "fs-xs" }, operatorTypes[(_a = currentFilters[key]) == null ? void 0 : _a.keyType][(_b = currentFilters[key]) == null ? void 0 : _b.op]), "  “", /* @__PURE__ */ React.createElement("span", { className: "limit-20" }, ((_c = currentFilters[key]) == null ? void 0 : _c.op) === "BETWEEN" && `min: ${(_d = currentFilters[key]) == null ? void 0 : _d.val.min}, max: ${(_e = currentFilters[key]) == null ? void 0 : _e.val.max}`, key === "lang" && langName((_f = currentFilters == null ? void 0 : currentFilters.lang) == null ? void 0 : _f.val), ((_g = currentFilters[key]) == null ? void 0 : _g.op) !== "BETWEEN" && key !== "lang" && ((_h = currentFilters[key]) == null ? void 0 : _h.filterValMenu) ? (_j = currentFilters[key]) == null ? void 0 : _j.filterValMenu[(_i = currentFilters[key]) == null ? void 0 : _i.val] : (_k = currentFilters[key]) == null ? void 0 : _k.val), "”"), /* @__PURE__ */ React.createElement(Tooltip, { className: "showOnHover" }, __("Edit filter"))),
      ...
      /* @__PURE__ */ React.createElement(TableFilterPanel, { key, props: { key, slug, header, initialRow, possibleFilters: state.possibleFilters, currentFilters }, onEdit: handleOnEdit })
    );
...
const _IconButton = "";
function IconButton({ className, style, children, tooltip, tooltipClass, onClick }) {
  return /* @__PURE__ */ React.createElement("button", { onClick, className: `urlslab-icon-button ${className || ""}`, style }, children, tooltip && /* @__PURE__ */ React.createElement(Tooltip, { className: `showOnHover ${tooltipClass}` }, tooltip));
}
function useChangeRow({ data, url, slug, pageId }) {
  ...
  }, [data == null ? void 0 : data.pages, getRowId, pageId]);
  ...
  const updateRowData = useMutation({
    mutationFn: async (options) => {
      ...
      if (changeField) {
        const response2 = await setData(`${slug}/${getRowId(cell, optionalSelector)}${customEndpoint || ""}`, { [changeField]: newVal });
        return response2;
      }
...
function DetailsPanel({ options, handlePanel }) {
  ...
  const {
    ...
    getNextPageParam: (allRows) => {
      ...
      const lastRowId = allRows[(allRows == null ? void 0 : allRows.length) - 1][listId] ?? void 0;
      return lastRowId;
    },
    keepPreviousData: true,
    refetchOnWindowFocus: false,
...
function TablePanels({ props: props2 }) {
  const { header, slug, currentFilters, initialRow, detailsOptions, insertOptions, exportOptions, activePanel, handlePanel } = props2;
  const { __ } = useI18n();
...
function ModuleViewHeaderBottom({ slug, noImport, noInsert, noExport, noCount, noDelete, header, table, insertOptions, activatePanel, detailsOptions, exportOptions, selectedRows, onSort, onFilter, onDeleteSelected, onClearRow }) {
  const { __ } = useI18n();
  const queryClient = useQueryClient();
  const didMountRef = reactExports.useRef(false);
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { ref: headerBottom, className: "urlslab-moduleView-headerBottom" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom__top flex flex-align-center" }, !noDelete && (selectedRows == null ? void 0 : selectedRows.length) > 0 && /* @__PURE__ */ React.createElement(Button, { className: "mr-s", onClick: () => handlePanel("deleteSelected") }, /* @__PURE__ */ React.createElement(SvgIconTrash, null), __("Delete selected")), insertOptions && !noInsert && /* @__PURE__ */ React.createElement(Button, { className: "active", onClick: () => handlePanel("addrow") }, /* @__PURE__ */ React.createElement(SvgIconPlus, null), insertOptions.title), /* @__PURE__ */ React.createElement("div", { className: "pos-relative" }, /* @__PURE__ */ React.createElement(Button, { className: "simple underline", onClick: () => dispatch({ type: "toggleEditFilter", editFilter: "addFilter" }) }, __("+ Add filter")), state.editFilter === "addFilter" && // Our main adding panel (only when Add button clicked)
  /* @__PURE__ */ React.createElement(TableFilterPanel, { props: { slug, header, initialRow, possibleFilters: state.possibleFilters, currentFilters }, onEdit: (val) => {
    handleHeaderHeight();
    handleOnEdit(val);
  } })), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, (!noImport || !noExport || !noDelete) && /* @__PURE__ */ React.createElement(TableActionsMenu, { onAction: handlePanel, options: { noImport, noExport, noDelete } }), table && /* @__PURE__ */ React.createElement(
    ColumnsMenu,
    {
  ...
  ), /* @__PURE__ */ React.createElement(IconButton, { className: "ml-m", tooltip: __("Refresh table"), tooltipClass: "align-left-0", onClick: handleRefresh }, /* @__PURE__ */ React.createElement(SvgIconCronRefresh, null)))), /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom__bottom mt-l flex flex-align-center" }, /* @__PURE__ */ React.createElement(TableFilter, { props: { currentFilters, state, slug, header, initialRow }, onEdit: handleOnEdit, onRemove: (key) => {
    handleHeaderHeight();
    handleRemoveFilter(key);
  } }), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, !noCount && rowCount && /* @__PURE__ */ React.createElement("small", { className: "urlslab-rowcount fadeInto flex flex-align-center" }, __("Rows: "), /* @__PURE__ */ React.createElement("strong", { className: "ml-s" }, rowCount)), /* @__PURE__ */ React.createElement(SortMenu, { className: "menu-left ml-m", isFilter: true, checkedId: sortBy, items: sortItems, name: "sorting", onChange: handleSorting }, `Sort by${sortBy ? ": " + sortItems[sortBy] : ""}`)))), /* @__PURE__ */ React.createElement(TablePanels, { props: { header, slug, currentFilters, initialRow, detailsOptions, insertOptions, exportOptions, activePanel, handlePanel } }));
}
...
export {
  ...
  useChangeRow as b,
  TooltipSortingFiltering as c,
  SvgIconCronRefresh as d,
  SvgIconPlus as e,
