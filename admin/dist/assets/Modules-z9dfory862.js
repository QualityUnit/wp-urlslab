import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-z9dfory862.js";
import { S as Switch } from "./Switch-z9dfory862.js";
import { S as SvgApiExclamation } from "./api-exclamation-z9dfory862.js";
import { u as useMutation } from "./useMutation-z9dfory862.js";
const __vite_glob_0_0 = "" + new URL("optimize-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-z9dfory862.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-z9dfory862.png", import.meta.url).href;
