import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-vxrwmwk0um.js";
import { S as Switch } from "./Switch-vxrwmwk0um.js";
import { S as SvgApiExclamation } from "./api-exclamation-vxrwmwk0um.js";
import { u as useMutation } from "./useMutation-vxrwmwk0um.js";
const __vite_glob_0_0 = "" + new URL("optimize-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-vxrwmwk0um.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-vxrwmwk0um.png", import.meta.url).href;
