import { r as reactExports, R as React, T as Tooltip, L as Loader } from "../main-vcojxzlfzii.js";
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, L as LangMenu, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table, P as ProgressBar } from "./useTableUpdater-vcojxzlfzii.js";
import { S as SortBy, I as IconButton } from "./_ColumnsMenu-vcojxzlfzii.js";
...
/* empty css                        */import { I as InputField, S as SortMenu, C as Checkbox } from "./InputField-vcojxzlfzii.js";
import { S as SvgIconEdit } from "./icon-edit-vcojxzlfzii.js";
import { S as SvgIconLink } from "./icon-link-vcojxzlfzii.js";
...
function KeywordsTable({ slug }) {
  ...
  const columns = [
    ...
    columnHelper.accessor("kwType", {
      ...
      className: "nolimit",
      cell: (cell) => /* @__PURE__ */ React.createElement(SortMenu, { items: keywordTypes, name: cell.column.id, defaultValue: cell.getValue(), onChange: (newVal) => updateRow({ newVal, cell }) }),
