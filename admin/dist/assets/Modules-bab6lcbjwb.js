import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-bab6lcbjwb.js";
import { S as Switch } from "./Switch-bab6lcbjwb.js";
import { S as SvgApiExclamation } from "./api-exclamation-bab6lcbjwb.js";
import { u as useMutation } from "./useMutation-bab6lcbjwb.js";
const __vite_glob_0_0 = "" + new URL("optimize-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-bab6lcbjwb.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-bab6lcbjwb.png", import.meta.url).href;
