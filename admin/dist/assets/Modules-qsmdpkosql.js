import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-qsmdpkosql.js";
import { S as Switch } from "./Switch-qsmdpkosql.js";
import { S as SvgApiExclamation } from "./api-exclamation-qsmdpkosql.js";
import { u as useMutation } from "./useMutation-qsmdpkosql.js";
const __vite_glob_0_0 = "" + new URL("optimize-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-qsmdpkosql.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-qsmdpkosql.png", import.meta.url).href;
