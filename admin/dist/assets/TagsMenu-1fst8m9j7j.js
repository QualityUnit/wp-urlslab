import { u as useI18n, r as reactExports, d as useQuery, G as postFetch, R as React, T as Tooltip, g as Tag, h as hexToHSL } from "../main-1fst8m9j7j.js";
import { u as useClickOutside, a as ReactTagsWithRef, I as IconButton } from "./_ColumnsMenu-1fst8m9j7j.js";
function TagsMenu({ label, description, defaultValue: tags, slug, hasActivator, onChange }) {
  ...
  function CustomTag({ classNames, tag, ...tagProps }) {
    ...
    return /* @__PURE__ */ React.createElement(Tag, { fullSize: hasActivator || tagsMenuActive, shape: !hasActivator && !tagsMenuActive && "circle", onDelete: () => tagsMenuActive && onDelete(tag), key: label_id, className: `${classNames.tag} ${className}`, ...tagProps, style: { backgroundColor: bgcolor, cursor: tagsMenuActive ? "default" : "pointer" } }, hasActivator || tagsMenuActive ? tag.label : tag.label.charAt(0));
  }
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "urlslab-TagsMenu-wrapper pos-relative" }, label && /* @__PURE__ */ React.createElement("div", { className: "urlslab-TagsMenu-label" }, label), /* @__PURE__ */ React.createElement("div", { onClick: !hasActivator && openTagsMenu, className: `urlslab-TagsMenu ${!hasActivator ? "noActivator" : ""} ${tagsMenuActive ? "active" : ""}`, ref: tagsMenuWrap }, !hasActivator && !tagsMenuActive === true && /* @__PURE__ */ React.createElement(Tooltip, { className: "showOnHover" }, __("Click to Add/remove tags")), /* @__PURE__ */ React.createElement(
    ReactTagsWithRef,
    {
      ref: tagsMenu,
  ...
  ), hasActivator && /* @__PURE__ */ React.createElement(IconButton, { onClick: openTagsMenu, className: "urlslab-TagsMenu-activator", tooltip: "Add new tag" }, "+")));
}
export {
  TagsMenu as T
};
