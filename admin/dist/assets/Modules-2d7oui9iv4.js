import { r as reactExports, u as useI18n, a as useQueryClient, R as React, T as Tag, s as setModule, b as useCheckApiKey } from "../main-2d7oui9iv4.js";
import { S as Switch } from "./Switch-2d7oui9iv4.js";
import { u as useMutation } from "./useMutation-2d7oui9iv4.js";
const __vite_glob_0_0 = "" + new URL("optimize-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("redirects-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-css-optimizer-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-generator-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-image-alt-attribute-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-keywords-links-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-lazy-loading-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-link-enhancer-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-media-offloader-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-meta-tag-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-related-resources-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("urlslab-screenshot-2d7oui9iv4.svg", import.meta.url).href;
const __vite_glob_0_12 = "" + new URL("urlslab-search-and-replace-2d7oui9iv4.svg", import.meta.url).href;
...
function DashboardModule({ moduleId, title, children, isActive, tags, activePage }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: `urlslab-dashboardmodule ${handleSwitch.isLoading ? "activating" : ""} ${isActive ? "active" : ""}` }, handleSwitch.isLoading ? /* @__PURE__ */ React.createElement("div", { className: "urlslab-dashboardmodule-activating" }, isActive ? __("Deactivating…") : __("Activating…")) : "", /* @__PURE__ */ React.createElement("div", { className: "urlslab-dashboardmodule-top flex-tablet flex-align-center" }, iconPath ? /* @__PURE__ */ React.createElement("img", { className: "urlslab-dashboardmodule-icon fadeInto", src: iconPath, alt: title }) : null, /* @__PURE__ */ React.createElement("h3", { className: "urlslab-dashboardmodule-title" }, title), labelsList.beta && /* @__PURE__ */ React.createElement(Tag, { className: "midSize c-white bg-primary-color" }, "BETA"), /* @__PURE__ */ React.createElement(
    Switch,
    {
      secondary: true,
