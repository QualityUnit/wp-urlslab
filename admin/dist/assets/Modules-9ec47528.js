import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main.js";
import { S as Switch } from "./Switch-d1e9295f.js";
import { S as SvgApiExclamation } from "./api-exclamation-0a77187a.js";
import { u as useMutation } from "./useMutation-88f18619.js";
const __vite_glob_0_0 = "" + new URL("urlslab-image-alt-attribute.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-keywords-links.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-lazy-loading.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-link-enhancer.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-media-offloader.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-meta-tag.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-related-resources.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-screenshot.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("yt_lazy_loading.png", import.meta.url).href;
...
function DashboardModule({ moduleId, title, children, isActive, hasApi, activePage }) {
  ...
  const imagePath = new URL((/* @__PURE__ */ Object.assign({ "../assets/images/modules/urlslab-image-alt-attribute.png": __vite_glob_0_0, "../assets/images/modules/urlslab-keywords-links.png": __vite_glob_0_1, "../assets/images/modules/urlslab-lazy-loading.png": __vite_glob_0_2, "../assets/images/modules/urlslab-link-enhancer.png": __vite_glob_0_3, "../assets/images/modules/urlslab-media-offloader.png": __vite_glob_0_4, "../assets/images/modules/urlslab-meta-tag.png": __vite_glob_0_5, "../assets/images/modules/urlslab-related-resources.png": __vite_glob_0_6, "../assets/images/modules/urlslab-screenshot.png": __vite_glob_0_7, "../assets/images/modules/yt_lazy_loading.png": __vite_glob_0_8 }))[`../assets/images/modules/${moduleId}.png`], self.location).pathname;
