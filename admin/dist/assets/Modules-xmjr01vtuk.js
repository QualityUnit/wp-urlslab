import { u as useI18n, a as useQueryClient, R as React, T as Tag, s as setModule, r as reactExports, d as delay, b as useCheckApiKey } from "../main-xmjr01vtuk.js";
import { S as Switch } from "./Switch-xmjr01vtuk.js";
import { u as useMutation, M as MultiSelectMenu } from "./MultiSelectMenu-xmjr01vtuk.js";
import "./Checkbox-xmjr01vtuk.js";
const __vite_glob_0_0 = "" + new URL("optimize-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("redirects-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-cache-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-css-optimizer-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-generator-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-image-alt-attribute-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-keywords-links-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-cache-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-link-enhancer-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-media-offloader-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-meta-tag-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("urlslab-related-resources-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_12 = "" + new URL("urlslab-screenshot-xmjr01vtuk.svg", import.meta.url).href;
const __vite_glob_0_13 = "" + new URL("urlslab-search-and-replace-xmjr01vtuk.svg", import.meta.url).href;
...
function DashboardModule({ moduleId, title, children, isActive, tags, activePage }) {
  ...
  const iconPath = new URL((/* @__PURE__ */ Object.assign({ "../assets/images/modules/optimize.svg": __vite_glob_0_0, "../assets/images/modules/redirects.svg": __vite_glob_0_1, "../assets/images/modules/urlslab-cache.svg": __vite_glob_0_2, "../assets/images/modules/urlslab-css-optimizer.svg": __vite_glob_0_3, "../assets/images/modules/urlslab-generator.svg": __vite_glob_0_4, "../assets/images/modules/urlslab-image-alt-attribute.svg": __vite_glob_0_5, "../assets/images/modules/urlslab-keywords-links.svg": __vite_glob_0_6, "../assets/images/modules/urlslab-lazy-loading.svg": __vite_glob_0_7, "../assets/images/modules/urlslab-link-enhancer.svg": __vite_glob_0_8, "../assets/images/modules/urlslab-media-offloader.svg": __vite_glob_0_9, "../assets/images/modules/urlslab-meta-tag.svg": __vite_glob_0_10, "../assets/images/modules/urlslab-related-resources.svg": __vite_glob_0_11, "../assets/images/modules/urlslab-screenshot.svg": __vite_glob_0_12, "../assets/images/modules/urlslab-search-and-replace.svg": __vite_glob_0_13 }))[`../assets/images/modules/${moduleId}.svg`], self.location).pathname;
  const { labels, labelsList } = tags;
  return /* @__PURE__ */ React.createElement("div", { className: `urlslab-dashboardmodule ${handleSwitch.isLoading ? "activating" : ""} ${isActive ? "active" : ""}` }, handleSwitch.isLoading ? /* @__PURE__ */ React.createElement("div", { className: "urlslab-dashboardmodule-activating" }, isActive ? __("Deactivating…") : __("Activating…")) : "", /* @__PURE__ */ React.createElement("div", { className: "urlslab-dashboardmodule-top flex-tablet flex-align-center" }, iconPath ? /* @__PURE__ */ React.createElement("img", { className: "urlslab-dashboardmodule-icon fadeInto", src: iconPath, alt: title }) : null, /* @__PURE__ */ React.createElement("h3", { className: "urlslab-dashboardmodule-title" }, /* @__PURE__ */ React.createElement("button", { className: `${isActive ? "active" : ""}`, onClick: isActive ? () => handleActive(moduleId) : null }, title)), /* @__PURE__ */ React.createElement(
    Switch,
    {
      secondary: true,
