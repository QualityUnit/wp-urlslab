import { Q as QueryObserver, i as infiniteQueryBehavior, j as hasNextPage, k as hasPreviousPage, l as parseQueryArgs, m as useBaseQuery, r as reactExports, u as useI18n, n as get, o as set, d as fetchData, R as React, a as useQueryClient, q as setData, B as Button, t as commonjsGlobal, c as useQuery, L as Loader } from "../settings.js";
...
function useInfiniteFetch(options, maxRows = 50) {
  ...
  reactExports.useEffect(() => {
    get(key).then((tableQuery) => {
      ...
      setActiveFilters(Object.keys(q == null ? void 0 : q.currentFilters).length ? q == null ? void 0 : q.currentFilters : {});
    });
    if (inView) {
      fetchNextPage();
    }
...
async function importCsv(slug, dataArray) {
  let processed = {};
  const dataChunks = () => {
    const chunkSize = 1e3;
    const chunkArray = [];
...
function ImportPanel({ slug, handlePanel }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel-wrap urlslab-panel-floating fadeInto" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel-header" }, /* @__PURE__ */ React.createElement("h3", null, __("Import data")), /* @__PURE__ */ React.createElement("button", { className: "urlslab-panel-close", onClick: () => hidePanel() }, /* @__PURE__ */ React.createElement(CloseIcon, null))), /* @__PURE__ */ React.createElement("div", { className: "flex" }, /* @__PURE__ */ React.createElement(Button, { className: "ma-left simple", onClick: () => hidePanel() }, __("Cancel")), /* @__PURE__ */ React.createElement(
    CSVReader,
    {
    ...
    ({
      ...
      acceptedFile,
      getRemoveFileProps
    }) => /* @__PURE__ */ React.createElement("div", { className: "ml-s flex flex-align-center" }, acceptedFile && /* @__PURE__ */ React.createElement("button", { className: "removeFile flex flex-align-center", ...getRemoveFileProps() }, acceptedFile.name, " ", /* @__PURE__ */ React.createElement(CloseIcon, null)), /* @__PURE__ */ React.createElement(Button, { ...getRootProps(), active: true }, /* @__PURE__ */ React.createElement(SvgIconImport, null), __("Import CSV")))
  ))));
}
...
function ModuleViewHeaderBottom({ currentFilters, noImport, noExport, noCount, noDelete, header, table, removeFilters, slug, exportOptions, defaultSortBy, onSort }) {
  var _a;
  const { __ } = useI18n();
  const queryClient = useQueryClient();
  const activeFilters = Object.keys(currentFilters);
  const [activePanel, setActivePanel] = reactExports.useState();
  const currentCountFilters = (_a = exportOptions == null ? void 0 : exportOptions.filters) == null ? void 0 : _a.replace("&", "?");
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom flex" }, !noDelete && /* @__PURE__ */ React.createElement(Button, { onClick: () => handlePanel("delete") }, /* @__PURE__ */ React.createElement(SvgIconTrash, null), __("Delete All")), !noExport && /* @__PURE__ */ React.createElement(Button, { className: "ml-s-tablet", onClick: () => handlePanel("export") }, /* @__PURE__ */ React.createElement(SvgIconExport, null), __("Export CSV")), !noImport && /* @__PURE__ */ React.createElement(Button, { className: "ml-s-tablet", onClick: () => handlePanel("import") }, /* @__PURE__ */ React.createElement(SvgIconImport, null), __("Import CSV")), (activeFilters == null ? void 0 : activeFilters.length) > 0 && header && /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center" }, activeFilters.map((key) => {
    return /* @__PURE__ */ React.createElement(Button, { className: "outline ml-s", key, onClick: () => removeFilters([key]) }, header[key], /* @__PURE__ */ React.createElement(SvgIconClose, { className: "close" }));
  }), /* @__PURE__ */ React.createElement(Button, { className: "simple underline", onClick: () => removeFilters(activeFilters) }, "Clear filters")), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, !noCount && /* @__PURE__ */ React.createElement("small", { className: "urlslab-rowcount mr-l flex flex-align-center" }, __("Rows: "), rowCount ? /* @__PURE__ */ React.createElement("strong", null, rowCount) : /* @__PURE__ */ React.createElement(Loader, { className: "noText small" })), /* @__PURE__ */ React.createElement("strong", null, __("Sort by:")), /* @__PURE__ */ React.createElement(SortMenu, { className: "menu-left ml-l", checkedId: defaultSortBy, items: sortItems, name: "sorting", onChange: (val) => onSort(val) }), /* @__PURE__ */ React.createElement(
    ColumnsMenu,
    {
