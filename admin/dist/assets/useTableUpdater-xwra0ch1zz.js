import { Q as QueryObserver, i as infiniteQueryBehavior, j as hasNextPage, k as hasPreviousPage, m as parseQueryArgs, n as useBaseQuery, R as React, r as reactExports, u as useI18n, d as fetchData, e as getParamsChar, L as Loader, a as useQueryClient, l as langName, o as get, q as update, t as setData, B as Button, h as commonjsGlobal, c as useQuery } from "../main-xwra0ch1zz.js";
import { T as Tooltip, S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./Tooltip-xwra0ch1zz.js";
import { u as useMutation } from "./useMutation-xwra0ch1zz.js";
...
function ModuleViewHeaderBottom({ slug, noImport, noInsert, noExport, noCount, noDelete, header, table, insertOptions, activatePanel, detailsOptions, exportOptions, selectedRows, onSort, onFilter, onDeleteSelected, onClearRow }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom__top flex flex-align-center" }, /* @__PURE__ */ React.createElement(Button, { className: "", onClick: () => handleRefresh() }, /* @__PURE__ */ React.createElement(SvgIconCronRefresh, null), __("Refresh table")), !noDelete && (selectedRows == null ? void 0 : selectedRows.length) > 0 && /* @__PURE__ */ React.createElement(Button, { className: "ml-s", onClick: () => handlePanel("deleteSelected") }, /* @__PURE__ */ React.createElement(SvgIconTrash, null), __("Delete selected")), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, !noDelete && /* @__PURE__ */ React.createElement(Button, { className: "no-padding underline simple", onClick: () => handlePanel("deleteall") }, __("Delete All")), !noExport && /* @__PURE__ */ React.createElement(Button, { className: "no-padding underline simple ml-m", onClick: () => handlePanel("export") }, __("Export CSV")), !noImport && /* @__PURE__ */ React.createElement(Button, { className: "no-padding underline simple ml-m", onClick: () => handlePanel("import") }, __("Import CSV")), insertOptions && !noInsert && /* @__PURE__ */ React.createElement(Button, { className: "ml-m active", onClick: () => handlePanel("addrow") }, /* @__PURE__ */ React.createElement(SvgIconPlus, null), insertOptions.title))), /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom__bottom mt-l flex flex-align-center" }, /* @__PURE__ */ React.createElement(TableFilter, { slug, header, initialRow, onFilter: setFiltersObj }), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, !noCount && rowCount && /* @__PURE__ */ React.createElement("small", { className: "urlslab-rowcount fadeInto flex flex-align-center" }, __("Rows: "), /* @__PURE__ */ React.createElement("strong", { className: "ml-s" }, rowCount)), /* @__PURE__ */ React.createElement(SortMenu, { className: "menu-left ml-m", isFilter: true, checkedId: sortBy, items: sortItems, name: "sorting", onChange: handleSorting }, `Sort by${sortBy ? ": " + sortItems[sortBy] : ""}`), table && /* @__PURE__ */ React.createElement(
    ColumnsMenu,
    {
