import { R as React, L as Loader, i as Tooltip } from "../main-vci0kn28n8.js";
import { a as useTableUpdater, b as useInfiniteFetch, c as useChangeRow, d as SortBy, I as IconButton, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table, P as ProgressBar } from "./ModuleViewHeaderBottom-vci0kn28n8.js";
...
import { I as InputField, S as SortMenu } from "./datepicker-vci0kn28n8.js";
import { T as TextArea } from "./Textarea-vci0kn28n8.js";
import { S as SvgIconEdit } from "./icon-edit-vci0kn28n8.js";
import "./transform-vci0kn28n8.js";
function CustomHtmlTable({ slug }) {
  ...
  const rowEditorCells = {
    name: /* @__PURE__ */ React.createElement(InputField, { liveUpdate: true, type: "text", defaultValue: "", label: header.name, onChange: (val) => setEditorRow({ ...rowToEdit, name: val }) }),
    ...
    rule_order: /* @__PURE__ */ React.createElement(InputField, { liveUpdate: true, type: "text", defaultValue: "10", label: header.rule_order, onChange: (val) => setEditorRow({ ...rowToEdit, rule_order: val }) }),
