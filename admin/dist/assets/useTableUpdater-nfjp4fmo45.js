import { Q as QueryObserver, A as infiniteQueryBehavior, C as hasNextPage, D as hasPreviousPage, E as parseQueryArgs, F as useBaseQuery, R as React, r as reactExports, u as useI18n, G as postFetch, a as useQueryClient, l as langName, H as get, B as Button, T as Tooltip, I as SvgIconClose, L as Loader, f as fetchData, k as getParamsChar, J as update, K as HeaderHeightContext, M as useResizeObserver, d as useQuery, S as SvgIconCronRefresh } from "../main-nfjp4fmo45.js";
import { u as useClickOutside, P, R, I as IconButton } from "./_ColumnsMenu-nfjp4fmo45.js";
import { S as SortMenu, I as InputField, M as MultiSelectMenu, H as Ht, C as Checkbox } from "./InputField-nfjp4fmo45.js";
/* empty css                       */import { u as useMutation } from "./useMutation-nfjp4fmo45.js";
...
function LangMenu({ noAll, multiSelect, isFilter, children, defaultAccept, onChange, defaultValue, autoClose }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, langData && !multiSelect ? /* @__PURE__ */ React.createElement(
    ...
    children
  ) : !multiSelect && /* @__PURE__ */ React.createElement(InputField, { defaultValue, onChange: (lang) => handleSelected(lang) }), langData && multiSelect && /* @__PURE__ */ React.createElement(
    MultiSelectMenu,
    {
      items: langData,
      isFilter,
  ...
  const updateRowData = useMutation({
    mutationFn: async (options) => {
      ...
      if (newVal) {
        ...
        if (changeField) {
          const response3 = await postFetch(`${slug}/${getRowId(cell, optionalSelector)}${customEndpoint || ""}`, { [changeField]: newVal });
          return response3;
        }
        const response2 = await postFetch(`${slug}/${getRowId(cell, optionalSelector)}${customEndpoint || ""}`, { [cellId]: newVal });
        return response2;
      }
...
function EditRowPanel({ rowEditorOptions, handlePanel }) {
  ...
  const { editorMode, rowEditorCells, title, text: text2, data, slug, url, paginationId, rowToEdit } = rowEditorOptions || {};
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel-wrap urlslab-panel-modal ultrawide fadeInto" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel-header" }, /* @__PURE__ */ React.createElement("h3", null, editorMode ? "Edit row" : title), /* @__PURE__ */ React.createElement("button", { className: "urlslab-panel-close", onClick: hidePanel }, /* @__PURE__ */ React.createElement(CloseIcon, null)), /* @__PURE__ */ React.createElement("p", null, text2)), /* @__PURE__ */ React.createElement("div", { className: "mt-l urlslab-panel-content" }, cellsFinal && Object.entries(cellsFinal).map(([cellId, cell]) => {
    return /* @__PURE__ */ React.createElement("div", { className: "mb-l urlslab-panel-content__item", key: cellId }, cell);
  })), /* @__PURE__ */ React.createElement("div", { className: "flex " }, /* @__PURE__ */ React.createElement(Button, { className: "ma-left simple", onClick: hidePanel }, __("Cancel")), /* @__PURE__ */ React.createElement(Button, { active: true, disabled: !enableAddButton.current, onClick: handleEdit }, editorMode ? __("Save changes") : title))));
}
...
function TablePanels({ props: props2 }) {
  ...
  ), activePanel === "rowInserter" && /* @__PURE__ */ React.createElement(EditRowPanel, { rowEditorOptions, handlePanel }), activePanel === "rowEditor" && /* @__PURE__ */ React.createElement(EditRowPanel, { rowEditorOptions: { editorMode: true, ...rowEditorOptions }, handlePanel }), activePanel === "export" && /* @__PURE__ */ React.createElement(
    ExportPanel,
    {
...
function ModuleViewHeaderBottom({ slug, noColumnsMenu, noFiltering, noImport, noInsert, noExport, noCount, noDelete, header, table, rowEditorOptions, activatePanel, detailsOptions, exportOptions, selectedRows, onFilter, onDeleteSelected, onUpdateRow }) {
  const { __ } = useI18n();
  const queryClient = useQueryClient();
  const didMountRef = reactExports.useRef(false);
  const panelPopover = reactExports.useRef();
