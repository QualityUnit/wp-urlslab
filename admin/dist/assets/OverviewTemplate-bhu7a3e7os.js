import { R as React, u as useI18n, r as reactExports, g as get, c as update, a as useQueryClient } from "../main-bhu7a3e7os.js";
...
const AboutIcon = "" + new URL("icon-overview-about-bhu7a3e7os.svg", import.meta.url).href;
const IntegrateIcon = "" + new URL("icon-overview-integrate-bhu7a3e7os.svg", import.meta.url).href;
const FaqIcon = "" + new URL("icon-overview-faq-bhu7a3e7os.svg", import.meta.url).href;
