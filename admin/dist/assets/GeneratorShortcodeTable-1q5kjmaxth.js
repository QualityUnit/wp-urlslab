import { r as reactExports, R as React, i as delay, T as Tooltip, L as Loader } from "../main-1q5kjmaxth.js";
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table, P as ProgressBar } from "./useTableUpdater-1q5kjmaxth.js";
import { D as DateTimeFormat } from "./DateTimeFormat-1q5kjmaxth.js";
import { E as Editor$1, S as SortBy, I as IconButton } from "./_ColumnsMenu-1q5kjmaxth.js";
...
import { S as SvgIconEdit } from "./icon-edit-1q5kjmaxth.js";
import { S as SvgIconActivate, a as SvgIconDisable } from "./icon-disable-1q5kjmaxth.js";
...
function Editor({ defaultValue, className, style, label, description, onChange }) {
  ...
  const [val, setVal] = reactExports.useState(defaultValue || "");
  const handleVal = reactExports.useCallback((value) => {
    if (onChange && (defaultValue !== val || !val)) {
      onChange(value);
    }
  }, [onChange, defaultValue, val]);
