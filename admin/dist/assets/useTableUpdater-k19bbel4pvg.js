import { Q as QueryObserver, j as infiniteQueryBehavior, k as hasNextPage, m as hasPreviousPage, n as parseQueryArgs, o as useBaseQuery, R as React, r as reactExports, u as useI18n, h as fetchData, a as useQueryClient, l as langName, q as get, t as update, v as setData, B as Button, i as commonjsGlobal, L as Loader, e as useQuery } from "../main-k19bbel4pvg.js";
import { S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox } from "./datepicker-k19bbel4pvg.js";
...
function DetailsPanel({ options, handlePanel }) {
  ...
  const {
    ...
    queryKey: [slug, url],
    queryFn: ({ pageParam = "" }) => {
      return fetchData(`${slug}/${url}?from_${listId}=${pageParam !== void 0 && pageParam}&rows_per_page=${maxRows}`);
    },
    getNextPageParam: (allRows) => {
      if (allRows.length < maxRows) {
        return void 0;
