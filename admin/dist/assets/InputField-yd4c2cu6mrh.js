import { r as reactExports, y as reactDomExports, R as React, z as ae, u as useI18n, i as delay } from "../main-yd4c2cu6mrh.js";
/* empty css                        */var classnamesExports = {};
var classnames = {
  get exports() {
...
function MultiSelectMenu({
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: `urlslab-MultiSelectMenu ${className || ""} ${isActive ? "active" : ""}`, style, ref, id }, children ? /* @__PURE__ */ React.createElement("div", { className: "urlslab-inputField-label", dangerouslySetInnerHTML: { __html: children } }) : null, /* @__PURE__ */ React.createElement(
    "div",
    {
      className: `urlslab-MultiSelectMenu__title ${isFilter ? "isFilter" : ""} ${isActive ? "active" : ""}`,
      onClick: handleMenu,
    ...
    return /* @__PURE__ */ React.createElement(
      Checkbox,
      {
        ...
        checked: checked == null ? void 0 : checked.includes(itemId)
      },
      value
    );
  })))), description && /* @__PURE__ */ React.createElement("p", { className: "urlslab-inputField-description" }, description));
}
function InputField({ defaultValue, autoFocus, placeholder, message, liveUpdate, className, type, readonly, disabled, label, description, labelInline, onChange, children, style }) {
