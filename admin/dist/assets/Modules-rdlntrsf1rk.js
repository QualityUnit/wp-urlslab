import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-rdlntrsf1rk.js";
import { S as Switch } from "./Switch-rdlntrsf1rk.js";
import { S as SvgApiExclamation } from "./api-exclamation-rdlntrsf1rk.js";
import { u as useMutation } from "./useMutation-rdlntrsf1rk.js";
const __vite_glob_0_0 = "" + new URL("optimize-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-rdlntrsf1rk.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-rdlntrsf1rk.png", import.meta.url).href;
