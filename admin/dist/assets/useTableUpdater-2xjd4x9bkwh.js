import { Q as QueryObserver, k as infiniteQueryBehavior, m as hasNextPage, n as hasPreviousPage, o as parseQueryArgs, q as useBaseQuery, R as React, r as reactExports, u as useI18n, h as fetchData, i as getParamsChar, a as useQueryClient, l as langName, t as get, v as update, w as setData, B as Button, j as commonjsGlobal, L as Loader, e as useQuery } from "../main-2xjd4x9bkwh.js";
import { S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox } from "./datepicker-2xjd4x9bkwh.js";
...
function useInfiniteFetch(options, maxRows = 50) {
  ...
  const query = useInfiniteQuery({
    ...
    queryFn: ({ pageParam = "" }) => {
      return fetchData(`${key}` + getParamsChar() + `from_${pageId}=${pageParam !== void 0 && pageParam}${url !== "undefined" ? url : ""}&rows_per_page=${maxRows}`);
    },
