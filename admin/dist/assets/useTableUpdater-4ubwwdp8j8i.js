import { Q as QueryObserver, i as infiniteQueryBehavior, j as hasNextPage, k as hasPreviousPage, m as parseQueryArgs, n as useBaseQuery, R as React, r as reactExports, u as useI18n, d as fetchData, e as getParamsChar, L as Loader, a as useQueryClient, l as langName, o as get, q as update, B as Button, t as setData, h as commonjsGlobal, H as HeaderHeightContext, v as useResizeObserver, c as useQuery } from "../main-4ubwwdp8j8i.js";
import { T as Tooltip, S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./Tooltip-4ubwwdp8j8i.js";
import { u as useMutation } from "./useMutation-4ubwwdp8j8i.js";
...
function TableFilter({ props: props2, onEdit, onRemove }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center flex-wrap" }, header && (activeFilters == null ? void 0 : activeFilters.map((key, index) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "flex" }, header[key], ": ", /* @__PURE__ */ React.createElement("span", { className: "regular flex" }, "“", /* @__PURE__ */ React.createElement("span", { className: "limit-20" }, ((_a = currentFilters[key]) == null ? void 0 : _a.op) === "BETWEEN" && !(currentFilters == null ? void 0 : currentFilters.lang) ? `min: ${(_b = currentFilters[key]) == null ? void 0 : _b.val.min}, max: ${(_c = currentFilters[key]) == null ? void 0 : _c.val.max}` : !(currentFilters == null ? void 0 : currentFilters.lang) && ((_d = currentFilters[key]) == null ? void 0 : _d.val), (currentFilters == null ? void 0 : currentFilters.lang) && langName((_e = currentFilters == null ? void 0 : currentFilters.lang) == null ? void 0 : _e.val)), "”"), /* @__PURE__ */ React.createElement(Tooltip, { className: "showOnHover" }, __("Edit filter"))),
