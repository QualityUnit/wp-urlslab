import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-djykm1j602.js";
import { S as Switch } from "./Switch-djykm1j602.js";
import { S as SvgApiExclamation } from "./api-exclamation-djykm1j602.js";
import { u as useMutation } from "./useMutation-djykm1j602.js";
const __vite_glob_0_0 = "" + new URL("optimize-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-djykm1j602.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-djykm1j602.png", import.meta.url).href;
