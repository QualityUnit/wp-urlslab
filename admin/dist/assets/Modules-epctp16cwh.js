import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-epctp16cwh.js";
import { S as Switch } from "./Switch-epctp16cwh.js";
import { S as SvgApiExclamation } from "./api-exclamation-epctp16cwh.js";
import { u as useMutation } from "./useMutation-epctp16cwh.js";
const __vite_glob_0_0 = "" + new URL("optimize-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-epctp16cwh.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-epctp16cwh.png", import.meta.url).href;
