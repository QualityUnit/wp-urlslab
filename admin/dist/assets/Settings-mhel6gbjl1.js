import { a as useQueryClient, r as reactExports, R as React, p as parseURL, B as Button, f as fetchData, e as setSettings, u as useI18n, h as useQuery, L as Loader, i as Tooltip, j as fetchSettings } from "../main-mhel6gbjl1.js";
import { S as SortMenu, H as Ht, I as InputField } from "./datepicker-mhel6gbjl1.js";
...
function SettingsOption({ settingId, option, renderTooltip }) {
  ...
  const renderOption = () => {
    switch (type) {
      ...
      case "listbox":
        return /* @__PURE__ */ React.createElement(SortMenu, { key: value, className: "wide", name: id, items: possible_values, defaultValue: value, autoClose: true, onChange: (selectedId) => handleChange.mutate(selectedId) }, title);
      case "multicheck":
        return /* @__PURE__ */ React.createElement(
          MultiSelectMenu,
          {
