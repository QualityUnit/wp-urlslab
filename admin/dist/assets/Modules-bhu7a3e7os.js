import { a as useQueryClient, r as reactExports, g as get, u as useI18n, b as useMainMenu, R as React, T as Tag, s as setModule, d as delay } from "../main-bhu7a3e7os.js";
import { S as Switch } from "./Switch-bhu7a3e7os.js";
import { u as useMutation, M as MultiSelectMenu } from "./MultiSelectMenu-bhu7a3e7os.js";
...
const __vite_glob_0_0 = "" + new URL("optimize-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("redirects-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-cache-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-css-optimizer-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-custom-html-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-generator-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-image-alt-attribute-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-keywords-links-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-cache-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-link-enhancer-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-media-offloader-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("urlslab-meta-tag-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_12 = "" + new URL("urlslab-related-resources-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_13 = "" + new URL("urlslab-screenshot-bhu7a3e7os.svg", import.meta.url).href;
const __vite_glob_0_14 = "" + new URL("urlslab-custom-html-bhu7a3e7os.svg", import.meta.url).href;
