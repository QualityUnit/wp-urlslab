import { Q as QueryObserver, A as infiniteQueryBehavior, C as hasNextPage, D as hasPreviousPage, E as parseQueryArgs, F as useBaseQuery, R as React, r as reactExports, u as useI18n, G as postFetch, a as useQueryClient, l as langName, H as get, B as Button, T as Tooltip, I as SvgIconClose, L as Loader, J as update, K as HeaderHeightContext, M as useResizeObserver, d as useQuery, S as SvgIconCronRefresh } from "../main-ajvvvo0ilk.js";
import { u as useClickOutside, P, R, I as IconButton } from "./_ColumnsMenu-ajvvvo0ilk.js";
import { S as SortMenu, I as InputField, M as MultiSelectMenu, H as Ht, C as Checkbox } from "./InputField-ajvvvo0ilk.js";
/* empty css                       */import { u as useMutation } from "./useMutation-ajvvvo0ilk.js";
    ...
    mutationFn: async (options) => {
      ...
      if (!paginateArray && data) {
        ...
        queryClient.setQueryData(
          [slug, filtersArray(filters), sorting],
          (origData) => {
            return origData;
          }
        );
...
function EditRowPanel({ rowEditorOptions, handlePanel }) {
  ...
  const [editMode, setEditMode] = reactExports.useState(rowToEdit && editorMode);
  if (rowToEdit) {
...
function TablePanels({ props: props2 }) {
  ...
  ), activePanel === "rowInserter" && /* @__PURE__ */ React.createElement(EditRowPanel, { rowEditorOptions, handlePanel }), activePanel === "rowEditor" && typeof rowEditorOptions.rowToEdit === "object" && /* @__PURE__ */ React.createElement(EditRowPanel, { rowEditorOptions: { editorMode: true, ...rowEditorOptions }, handlePanel }), activePanel === "export" && /* @__PURE__ */ React.createElement(
    ExportPanel,
    {
