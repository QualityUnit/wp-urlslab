import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-b65fm56nnz.js";
import { S as Switch } from "./Switch-b65fm56nnz.js";
import { S as SvgApiExclamation } from "./api-exclamation-b65fm56nnz.js";
import { u as useMutation } from "./useMutation-b65fm56nnz.js";
const __vite_glob_0_0 = "" + new URL("optimize-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-b65fm56nnz.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-b65fm56nnz.png", import.meta.url).href;
