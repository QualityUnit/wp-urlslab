import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-m7bh6s4noj.js";
import { S as Switch } from "./Switch-m7bh6s4noj.js";
import { S as SvgApiExclamation } from "./api-exclamation-m7bh6s4noj.js";
import { u as useMutation } from "./useMutation-m7bh6s4noj.js";
const __vite_glob_0_0 = "" + new URL("optimize-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-m7bh6s4noj.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-m7bh6s4noj.png", import.meta.url).href;
