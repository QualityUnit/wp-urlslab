import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-vslnfngraa.js";
import { S as Switch } from "./Switch-vslnfngraa.js";
import { S as SvgApiExclamation } from "./api-exclamation-vslnfngraa.js";
import { u as useMutation } from "./useMutation-vslnfngraa.js";
const __vite_glob_0_0 = "" + new URL("optimize-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-vslnfngraa.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-vslnfngraa.png", import.meta.url).href;
