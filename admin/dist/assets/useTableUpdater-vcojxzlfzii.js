import { Q as QueryObserver, A as infiniteQueryBehavior, C as hasNextPage, D as hasPreviousPage, E as parseQueryArgs, F as useBaseQuery, R as React, r as reactExports, u as useI18n, G as postFetch, a as useQueryClient, l as langName, H as get, B as Button, T as Tooltip, I as SvgIconClose, L as Loader, f as fetchData, k as getParamsChar, J as update, K as HeaderHeightContext, M as useResizeObserver, d as useQuery, S as SvgIconCronRefresh } from "../main-vcojxzlfzii.js";
import { u as useClickOutside, P, R, I as IconButton } from "./_ColumnsMenu-vcojxzlfzii.js";
import { S as SortMenu, I as InputField, M as MultiSelectMenu, H as Ht, C as Checkbox } from "./InputField-vcojxzlfzii.js";
/* empty css                        */import { u as useMutation } from "./useMutation-vcojxzlfzii.js";
...
function LangMenu({ noAll, multiSelect, isFilter, children, defaultAccept, onChange, defaultValue, autoClose }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, langs && !multiSelect ? /* @__PURE__ */ React.createElement(
    ...
    children
  ) : !multiSelect && /* @__PURE__ */ React.createElement(InputField, { defaultValue, onChange: (lang) => handleSelected(lang) }), langs && multiSelect && /* @__PURE__ */ React.createElement(
    MultiSelectMenu,
    {
      items: langs,
      isFilter,
