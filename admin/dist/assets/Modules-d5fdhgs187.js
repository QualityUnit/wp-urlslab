import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-d5fdhgs187.js";
import { S as Switch } from "./Switch-d5fdhgs187.js";
import { S as SvgApiExclamation } from "./api-exclamation-d5fdhgs187.js";
import { u as useMutation } from "./useMutation-d5fdhgs187.js";
const __vite_glob_0_0 = "" + new URL("optimize-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-d5fdhgs187.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-d5fdhgs187.png", import.meta.url).href;
