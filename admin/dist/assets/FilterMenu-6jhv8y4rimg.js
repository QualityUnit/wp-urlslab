import { r as reactExports, y as reactDomExports, R as React, z as ae, A as delay, u as useI18n } from "../main-6jhv8y4rimg.js";
...
function InputField({ defaultValue, autoFocus, placeholder, message, liveUpdate, className, type, readonly, disabled, label, labelInline, onChange, children, style }) {
...
function FilterMenu({
  ...
  ), /* @__PURE__ */ React.createElement("div", { className: `urlslab-FilterMenu__items ${isActive ? "active" : ""} ${isVisible ? "visible" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: `urlslab-FilterMenu__items--inn ${(items == null ? void 0 : items.length) > 8 ? "has-scrollbar" : ""}` }, Object.entries(items).map(([itemId, value]) => {
    return /* @__PURE__ */ React.createElement(
      Checkbox,
      {
        className: "urlslab-FilterMenu__item",
