import { i as commonjsGlobal, R as React, r as reactExports, L as Loader } from "../main-5zl6z7defw.js";
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, T as Tooltip, S as SvgIconTrash, M as ModuleViewHeaderBottom, c as Table, P as ProgressBar } from "./useTableUpdater-5zl6z7defw.js";
import { C as Checkbox } from "./datepicker-5zl6z7defw.js";
import "./useMutation-5zl6z7defw.js";
var uaParserExports = {};
var uaParser = {
  get exports() {
...
const Safari = "" + new URL("safari_48x48-5zl6z7defw.png", import.meta.url).href;
...
const IE = "" + new URL("internet-explorer_9-11_48x48-5zl6z7defw.png", import.meta.url).href;
...
const Windows = "" + new URL("WIN-5zl6z7defw.png", import.meta.url).href;
const macOs = "" + new URL("MAC-5zl6z7defw.png", import.meta.url).href;
const iOS = "" + new URL("IOS-5zl6z7defw.png", import.meta.url).href;
...
const Linux = "" + new URL("LIN-5zl6z7defw.png", import.meta.url).href;
const Android = "" + new URL("AND-5zl6z7defw.png", import.meta.url).href;
function BrowserIcon({ browserName, osName }) {
  const browserNameOk = browserName == null ? void 0 : browserName.replaceAll(" ", "");
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center" }, browserIcons[browserNameOk] ? /* @__PURE__ */ React.createElement("img", { className: "browserIcon", src: browserIcons[browserNameOk], alt: browserName }) : /* @__PURE__ */ React.createElement("img", { className: "browserIcon", src: Generic, alt: "Unknown browser" }), osIcons[osNameOk] ? /* @__PURE__ */ React.createElement("img", { className: "ml-s browserIcon", src: osIcons[osNameOk], alt: osName }) : /* @__PURE__ */ React.createElement("strong", { className: "limit" }, " ", osName));
}
function NotFoundTable({ slug }) {
  ...
  const columns = [
    ...
    columnHelper == null ? void 0 : columnHelper.accessor((cell) => {
      ...
      tooltip: (cell) => /* @__PURE__ */ React.createElement(Tooltip, null, cell.getValue()),
      cell: (cell) => {
        const { browser, os, ua } = uaParserExports.UAParser(cell.getValue());
        return /* @__PURE__ */ React.createElement(BrowserIcon, { browserName: browser.name, osName: os.name || ua });
      },
      header: header.agent,
      size: 150
    }),
