import { Q as QueryObserver, i as infiniteQueryBehavior, j as hasNextPage, k as hasPreviousPage, m as parseQueryArgs, n as useBaseQuery, R as React, r as reactExports, u as useI18n, d as fetchData, e as getParamsChar, L as Loader, a as useQueryClient, l as langName, o as get, B as Button, q as update, t as setData, h as commonjsGlobal, c as useQuery } from "../main-0j87fm3m8vj.js";
import { T as Tooltip, S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./Tooltip-0j87fm3m8vj.js";
import { u as useMutation } from "./useMutation-0j87fm3m8vj.js";
...
function TableFilterPanel({ props: props2, onEdit }) {
  ...
  const { __ } = useI18n();
  const filterPanel = reactExports.useRef();
  ...
  return /* @__PURE__ */ React.createElement("div", { ref: filterPanel, className: `urlslab-panel fadeInto urslab-TableFilter-panel pos-absolute` }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-panel-header urslab-TableFilter-panel-header" }, /* @__PURE__ */ React.createElement("strong", null, __("Edit filter"), key ? ` ${header[key]}` : "")), /* @__PURE__ */ React.createElement("div", { className: "flex mt-m mb-m flex-align-center" }, /* @__PURE__ */ React.createElement(
    SortMenu,
    {
      className: "mr-s",
    ...
    SortMenu,
    {
      ...
      defaultAccept: true,
      autoClose: true,
      checkedId: ((_o = currentFilters[key]) == null ? void 0 : _o.val) || Object.keys(filterValMenu)[0],
    ...
    SortMenu,
    {
      ...
      defaultAccept: true,
      autoClose: true,
      checkedId: ((_p = currentFilters[key]) == null ? void 0 : _p.val) || Object.keys(booleanTypes)[0],
      onChange: (val) => dispatch({ type: "setFilterVal", val })
    }
  ), state.filterObj.keyType === "string" && notBetween && /* @__PURE__ */ React.createElement(InputField, { liveUpdate: true, autoFocus: true, defaultValue: (_q = currentFilters[key]) == null ? void 0 : _q.val, placeholder: state.filterObj.filterOp === "IN" ? "enter ie. 0,10,15,20" : "Enter search term", onChange: (val) => dispatch({ type: "setFilterVal", val }) }), state.filterObj.keyType === "number" && notBetween && /* @__PURE__ */ React.createElement(InputField, { type: "number", liveUpdate: true, autoFocus: true, defaultValue: cellUnit === "kB" ? ((_r = currentFilters[key]) == null ? void 0 : _r.val) / 1024 : (_s = currentFilters[key]) == null ? void 0 : _s.val, placeholder: state.filterObj.filterOp === "IN" ? "enter ie. 0,10,15,20" : `Enter size ${cellUnit && "in " + cellUnit}`, onChange: (val) => dispatch({ type: "setFilterVal", val: cellUnit === "kB" ? val * 1024 : val }) }), state.filterObj.keyType === "date" && notBetween && // Datepicker not between
  ...
  /* @__PURE__ */ React.createElement("div", { className: "urlslab-datetime-range" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-inputField-datetime" }, /* @__PURE__ */ React.createElement(
    ...
    RangeInputs,
    {
      liveUpdate: true,
      unit: cellUnit,
      defaultMin: (_t = currentFilters[key]) == null ? void 0 : _t.val.min,
      defaultMax: (_u = currentFilters[key]) == null ? void 0 : _u.val.max,
      onChange: (val) => dispatch({ type: "setFilterVal", val })
    }
...
function TableFilter({ props: props2, onEdit, onRemove }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center flex-wrap" }, header && (activeFilters == null ? void 0 : activeFilters.map((key) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(TableFilterPanel, { props: { key, slug, header, initialRow, possibleFilters: state.possibleFilters, currentFilters }, onEdit: (val) => onEdit(val) })
    );
...
function ModuleViewHeaderBottom({ slug, noImport, noInsert, noExport, noCount, noDelete, header, table, insertOptions, activatePanel, detailsOptions, exportOptions, selectedRows, onSort, onFilter, onDeleteSelected, onClearRow }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom" }, /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom__top flex flex-align-center" }, !noDelete && (selectedRows == null ? void 0 : selectedRows.length) > 0 && /* @__PURE__ */ React.createElement(Button, { className: "mr-s", onClick: () => handlePanel("deleteSelected") }, /* @__PURE__ */ React.createElement(SvgIconTrash, null), __("Delete selected")), insertOptions && !noInsert && /* @__PURE__ */ React.createElement(Button, { className: "active", onClick: () => handlePanel("addrow") }, /* @__PURE__ */ React.createElement(SvgIconPlus, null), insertOptions.title), /* @__PURE__ */ React.createElement("div", { className: "pos-relative" }, /* @__PURE__ */ React.createElement(Button, { className: "simple underline", onClick: () => dispatch({ type: "toggleEditFilter", editFilter: "addFilter" }) }, __("+ Add filter")), state.editFilter === "addFilter" && // Our main adding panel (only when Add button clicked)
  /* @__PURE__ */ React.createElement(TableFilterPanel, { props: { slug, header, initialRow, possibleFilters: state.possibleFilters, currentFilters }, onEdit: handleOnEdit })), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, !noImport && !noExport && !noDelete && /* @__PURE__ */ React.createElement(TableActionsMenu, { onAction: handlePanel, options: { noImport, noExport, noDelete } }), table && /* @__PURE__ */ React.createElement(
    ColumnsMenu,
    {
  ...
  ), /* @__PURE__ */ React.createElement(IconButton, { className: "ml-m", tooltip: __("Refresh table"), tooltipClass: "align-left-0", onClick: handleRefresh }, /* @__PURE__ */ React.createElement(SvgIconCronRefresh, null)))), /* @__PURE__ */ React.createElement("div", { className: "urlslab-moduleView-headerBottom__bottom mt-l flex flex-align-center" }, /* @__PURE__ */ React.createElement(TableFilter, { props: { currentFilters, state, slug, header, initialRow }, onEdit: handleOnEdit, onRemove: (key) => handleRemoveFilter(key) }), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, !noCount && rowCount && /* @__PURE__ */ React.createElement("small", { className: "urlslab-rowcount fadeInto flex flex-align-center" }, __("Rows: "), /* @__PURE__ */ React.createElement("strong", { className: "ml-s" }, rowCount)), /* @__PURE__ */ React.createElement(SortMenu, { className: "menu-left ml-m", isFilter: true, checkedId: sortBy, items: sortItems, name: "sorting", onChange: handleSorting }, `Sort by${sortBy ? ": " + sortItems[sortBy] : ""}`)))), activePanel === "deleteall" && /* @__PURE__ */ React.createElement(
    DangerPanel,
    {
      title: __("Delete All?"),
