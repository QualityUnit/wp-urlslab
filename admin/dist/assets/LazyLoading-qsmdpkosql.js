...
function LazyLoading({ moduleId }) {
  ...
  const YouTubeCacheTable = reactExports.lazy(() => __vitePreload(() => import("./YouTubeCacheTable-qsmdpkosql.js"), true ? ["./YouTubeCacheTable-qsmdpkosql.js","../main-qsmdpkosql.js","./main.css","./useTableUpdater-qsmdpkosql.js","./datepicker-qsmdpkosql.js","./datepicker-qsmdpkosql.css","./useMutation-qsmdpkosql.js","./useTableUpdater-qsmdpkosql.css"] : void 0, import.meta.url));
  const ContentCacheTable = reactExports.lazy(() => __vitePreload(() => import("./ContentCacheTable-qsmdpkosql.js"), true ? ["./ContentCacheTable-qsmdpkosql.js","../main-qsmdpkosql.js","./main.css","./useTableUpdater-qsmdpkosql.js","./datepicker-qsmdpkosql.js","./datepicker-qsmdpkosql.css","./useMutation-qsmdpkosql.js","./useTableUpdater-qsmdpkosql.css"] : void 0, import.meta.url));
