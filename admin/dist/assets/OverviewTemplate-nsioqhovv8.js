import { R as React, u as useI18n, r as reactExports, g as get, a as useQueryClient, c as update } from "../main-nsioqhovv8.js";
/* empty css                              */import { C as Checkbox } from "./Checkbox-nsioqhovv8.js";
const _SimpleButton = "";
...
function ModuleViewHeader({ moduleId, moduleMenu, activeMenu, noSettings }) {
  ...
  const getOverviewVisibility = reactExports.useCallback(async () => {
    ...
    if ((moduleData == null ? void 0 : moduleData.hideOverview) && moduleMenu) {
...
const AboutIcon = "" + new URL("icon-overview-about-nsioqhovv8.svg", import.meta.url).href;
const IntegrateIcon = "" + new URL("icon-overview-integrate-nsioqhovv8.svg", import.meta.url).href;
const FaqIcon = "" + new URL("icon-overview-faq-nsioqhovv8.svg", import.meta.url).href;
...
function Overview({ moduleId, noFAQ, noIntegrate, noCheckbox, title, customSections, section, children }) {
  ...
  const [overViewVisible, setOverviewVisibility] = reactExports.useState(false);
