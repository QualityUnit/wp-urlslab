import { Q as QueryObserver, i as infiniteQueryBehavior, j as hasNextPage, k as hasPreviousPage, m as parseQueryArgs, n as useBaseQuery, R as React, r as reactExports, u as useI18n, d as fetchData, e as getParamsChar, L as Loader, a as useQueryClient, l as langName, o as get, q as update, t as setData, B as Button, h as commonjsGlobal, c as useQuery } from "../main-qsmdpkosql.js";
import { T as Tooltip, S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./datepicker-qsmdpkosql.js";
import { u as useMutation } from "./useMutation-qsmdpkosql.js";
...
function useChangeRow({ data, url, slug, pageId }) {
  ...
  const selectRow = reactExports.useCallback((isSelected, cell) => {
...
function ModuleViewHeaderBottom({ slug, noImport, noInsert, noExport, noCount, noDelete, header, table, insertOptions, activatePanel, detailsOptions, exportOptions, rowsSelected, onSort, onFilter, onClearRow }) {
  var _a;
  const { __ } = useI18n();
  const queryClient = useQueryClient();
