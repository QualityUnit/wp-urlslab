import { Q as QueryObserver, i as infiniteQueryBehavior, h as hasNextPage, g as hasPreviousPage, j as parseQueryArgs, k as useBaseQuery, r as reactExports, u as useI18n, l as get, m as set, n as fetchData, R as React, a as useQueryClient, o as setData, B as Button, q as commonjsGlobal, c as useQuery, L as Loader } from "../settings.js";
import { S as SortMenu } from "./datepicker-ff7dcd9b.js";
...
function Table({ resizable, children, className, columns, data, inserter }) {
  var _a, _b;
...
function ModuleViewHeaderBottom({ currentFilters, noImport, noExport, noCount, noDelete, header, removeFilters, slug, exportOptions, defaultSortBy, onSort }) {
  var _a;
  const { __ } = useI18n();
  const queryClient = useQueryClient();
  const activeFilters = Object.keys(currentFilters);
  ...
  }), /* @__PURE__ */ React.createElement(Button, { className: "simple underline", onClick: () => removeFilters(activeFilters) }, "Clear filters")), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, /* @__PURE__ */ React.createElement("strong", null, __("Sort by:")), /* @__PURE__ */ React.createElement(SortMenu, { className: "menu-left ml-s", checkedId: defaultSortBy, items: sortItems, name: "sorting", onChange: (val) => onSort(val) }), !noCount && /* @__PURE__ */ React.createElement("small", { className: "urlslab-rowcount ml-l flex flex-align-center" }, __("Rows: "), rowCount ? rowCount : /* @__PURE__ */ React.createElement(Loader, { className: "noText small" })))), activePanel === "delete" && /* @__PURE__ */ React.createElement(
    DangerPanel,
    {
      title: __("Delete All?"),
