import { i as commonjsGlobal, R as React, r as reactExports, L as Loader } from "../main-k5hry376nn.js";
...
import { C as Checkbox } from "./datepicker-k5hry376nn.js";
...
const Safari = "" + new URL("safari_48x48-k5hry376nn.png", import.meta.url).href;
...
const IE = "" + new URL("internet-explorer_9-11_48x48-k5hry376nn.png", import.meta.url).href;
...
function BrowserIcon({ browserName }) {
  ...
  return browserNameOk ? /* @__PURE__ */ React.createElement("img", { className: "browserIcon", src: browserIcons[browserNameOk], alt: browserName }) : /* @__PURE__ */ React.createElement("img", { className: "browserIcon", src: Fake, alt: "bot" });
}
  ...
  const columns = [
    ...
    columnHelper == null ? void 0 : columnHelper.accessor((cell) => {
      ...
      cell: (cell) => {
        ...
        return /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center" }, /* @__PURE__ */ React.createElement(BrowserIcon, { browserName: browser.name }), " ", /* @__PURE__ */ React.createElement("strong", null, os.name ? os.name : ua));
      },
      header: header.agent,
      size: 150
    }),
