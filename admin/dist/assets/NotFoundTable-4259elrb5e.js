import { r as reactExports, R as React, L as Loader } from "../main-4259elrb5e.js";
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, T as Tooltip, S as SvgIconTrash, M as ModuleViewHeaderBottom, c as Table } from "./useTableUpdater-4259elrb5e.js";
import { C as Checkbox } from "./datepicker-4259elrb5e.js";
import "./useMutation-4259elrb5e.js";
function NotFoundTable({ slug }) {
  ...
  const columns = [
    ...
    columnHelper == null ? void 0 : columnHelper.accessor((cell) => {
      var _a2;
      return (_a2 = JSON.parse(`${cell == null ? void 0 : cell.request_data}`)) == null ? void 0 : _a2.agent;
    }, {
      id: "agent",
      tooltip: (cell) => /* @__PURE__ */ React.createElement(Tooltip, null, cell.getValue()),
      cell: (cell) => {
    ...
    columnHelper == null ? void 0 : columnHelper.accessor((cell) => {
      var _a2;
      return (_a2 = JSON.parse(`${cell == null ? void 0 : cell.request_data}`)) == null ? void 0 : _a2.referer;
    }, {
      id: "referer",
      tooltip: (cell) => /* @__PURE__ */ React.createElement(Tooltip, null, cell.getValue()),
      cell: (cell) => {
