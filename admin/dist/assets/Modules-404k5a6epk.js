import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-404k5a6epk.js";
import { S as Switch } from "./Switch-404k5a6epk.js";
import { S as SvgApiExclamation } from "./api-exclamation-404k5a6epk.js";
import { u as useMutation } from "./useMutation-404k5a6epk.js";
const __vite_glob_0_0 = "" + new URL("optimize-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-404k5a6epk.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-404k5a6epk.png", import.meta.url).href;
