...
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table, P as ProgressBar } from "./useTableUpdater-vcojxzlfzii.js";
import { D as DateTimeFormat } from "./DateTimeFormat-vcojxzlfzii.js";
...
/* empty css                        */import { S as SortBy } from "./_ColumnsMenu-vcojxzlfzii.js";
import { C as Checkbox, S as SortMenu } from "./InputField-vcojxzlfzii.js";
...
function LinkManagerTable({ slug }) {
  ...
  const columns = [
    ...
    columnHelper.accessor("url_type", {
      ...
      header: (th) => /* @__PURE__ */ React.createElement(SortBy, { props: { header, sorting, th, onClick: () => sortBy(th) } }, header.url_type),
      size: 80
    }),
