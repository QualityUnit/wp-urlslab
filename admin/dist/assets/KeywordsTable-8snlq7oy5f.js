...
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, L as LangMenu, T as Tooltip, S as SvgIconTrash, M as ModuleViewHeaderBottom, c as Table, P as ProgressBar } from "./useTableUpdater-8snlq7oy5f.js";
import { I as InputField, S as SortMenu, C as Checkbox } from "./datepicker-8snlq7oy5f.js";
import { S as SvgIconLink } from "./icon-link-8snlq7oy5f.js";
...
function KeywordsTable({ slug }) {
  ...
  const columns = [
    ...
    columnHelper.accessor("link_usage_count", {
      cell: (cell) => /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center" }, cell == null ? void 0 : cell.getValue(), (cell == null ? void 0 : cell.getValue()) > 0 && /* @__PURE__ */ React.createElement("button", { className: "ml-s", onClick: () => setDetailsOptions({
        title: `Link used on these URLs`,
        text: `Results for link: ${cell.row.original.url_name} of keyword “${cell.row.original.keyword}”`,
        slug: "url",
        url: `${cell.row.original.dest_url_id}/linked-from`,
