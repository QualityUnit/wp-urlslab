import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-4259elrb5e.js";
import { S as Switch } from "./Switch-4259elrb5e.js";
import { S as SvgApiExclamation } from "./api-exclamation-4259elrb5e.js";
import { u as useMutation } from "./useMutation-4259elrb5e.js";
const __vite_glob_0_0 = "" + new URL("optimize-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-4259elrb5e.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-4259elrb5e.png", import.meta.url).href;
