import { Q as QueryObserver, j as infiniteQueryBehavior, k as hasNextPage, m as hasPreviousPage, n as parseQueryArgs, o as useBaseQuery, R as React, r as reactExports, u as useI18n, q as postFetch, T as Tooltip, L as Loader, I as IconButton, a as useQueryClient, l as langName, t as get, v as update, B as Button, i as commonjsGlobal, f as fetchData, h as getParamsChar, H as HeaderHeightContext, w as useResizeObserver, d as useQuery, S as SvgIconCronRefresh } from "../main-pk96ffxtp2j.js";
import { S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./datepicker-pk96ffxtp2j.js";
import { u as useMutation } from "./useMutation-pk96ffxtp2j.js";
...
function TooltipSortingFiltering({ props: props2 }) {
  const { __ } = useI18n();
  const { isFetching, sorting, filters } = props2;
...
function TableFilter({ props: props2, onEdit, onRemove }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-align-center flex-wrap" }, header && (activefilters == null ? void 0 : activefilters.map((key, index) => {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(TableFilterPanel, { key, props: { key, slug, header, initialRow, possiblefilters, filters }, onEdit: handleOnEdit })
    );
...
function ModuleViewHeaderBottom({ slug, noFiltering, noImport, noInsert, noExport, noCount, noDelete, header, table, insertOptions, activatePanel, detailsOptions, exportOptions, selectedRows, onFilter, onDeleteSelected, onClearRow }) {
  const { __ } = useI18n();
  const queryClient = useQueryClient();
  const didMountRef = reactExports.useRef(false);
  ...
  /* @__PURE__ */ React.createElement(TableFilterPanel, { props: { slug, header, initialRow, possiblefilters, filters }, onEdit: (val) => {
    handleHeaderHeight();
    handleOnEdit(val);
  } })), /* @__PURE__ */ React.createElement("div", { className: "ma-left flex flex-align-center" }, /* @__PURE__ */ React.createElement(Counter, null), !noImport && !noExport && !noDelete && /* @__PURE__ */ React.createElement(TableActionsMenu, { onAction: handlePanel, options: { noImport, noExport, noDelete } }), table && /* @__PURE__ */ React.createElement(
    ColumnsMenu,
    {
