import { r as reactExports, R as React, i as Tooltip, L as Loader } from "../main-mhel6gbjl1.js";
import { a as useTableUpdater, b as useInfiniteFetch, c as useChangeRow, L as LangMenu, d as SortBy, I as IconButton, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table, P as ProgressBar } from "./ModuleViewHeaderBottom-mhel6gbjl1.js";
...
import { I as InputField, S as SortMenu } from "./datepicker-mhel6gbjl1.js";
import { C as Checkbox } from "./Checkbox-mhel6gbjl1.js";
import { S as SuggestInputField } from "./SuggestInputField-mhel6gbjl1.js";
import { S as SvgIconEdit } from "./icon-edit-mhel6gbjl1.js";
import { S as SvgIconLink } from "./icon-link-mhel6gbjl1.js";
function KeywordsTable({ slug }) {
  ...
  const rowEditorCells = {
    keyword: /* @__PURE__ */ React.createElement(InputField, { autoFocus: true, liveUpdate: true, defaultValue: "", label: header.keyword, onChange: (val) => setEditorRow({ ...rowToEdit, keyword: val }), required: true }),
    urlLink: /* @__PURE__ */ React.createElement(SuggestInputField, { suggestInput: (rowToEdit == null ? void 0 : rowToEdit.keyword) || "", liveUpdate: true, defaultValue: "", label: header.urlLink, onChange: (val) => setEditorRow({ ...rowToEdit, urlLink: val }), required: true }),
