import { Q as QueryObserver, i as infiniteQueryBehavior, j as hasNextPage, k as hasPreviousPage, m as parseQueryArgs, n as useBaseQuery, R as React, r as reactExports, u as useI18n, h as fetchData, a as useQueryClient, l as langName, o as get, q as update, t as setData, B as Button, v as commonjsGlobal, e as useQuery } from "../main-4259elrb5e.js";
import { S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox } from "./datepicker-4259elrb5e.js";
  ...
  reactExports.useEffect(() => {
    get(slug).then((dbData) => {
      if ((dbData == null ? void 0 : dbData.columnVisibility) && Object.keys(dbData == null ? void 0 : dbData.columnVisibility).length) {
        setColumnVisibility(dbData == null ? void 0 : dbData.columnVisibility);
      }
    });
