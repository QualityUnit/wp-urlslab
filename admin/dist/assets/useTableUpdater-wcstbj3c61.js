import { Q as QueryObserver, i as infiniteQueryBehavior, j as hasNextPage, k as hasPreviousPage, m as parseQueryArgs, n as useBaseQuery, R as React, r as reactExports, u as useI18n, d as fetchData, e as getParamsChar, a as useQueryClient, l as langName, o as get, q as update, t as setData, B as Button, h as commonjsGlobal, L as Loader, c as useQuery } from "../main-wcstbj3c61.js";
import { S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./datepicker-wcstbj3c61.js";
import { u as useMutation } from "./useMutation-wcstbj3c61.js";
...
function TooltipSortingFiltering({ props: props2 }) {
  ...
  return /* @__PURE__ */ React.createElement(React.Fragment, null, isFetching && (sortingColumn || filters) ? /* @__PURE__ */ React.createElement(Tooltip, { center: true }, __("Filtering & Sorting…")) : null);
}
const _RangeSlider = "";
...
function TableFilterPanel({ props: props2, onEdit }) {
  ...
  console.log((_l = currentFilters[key]) == null ? void 0 : _l.val);
  ...
  reactExports.useEffect(() => {
    ...
    if (state.filterObj.keyType === "lang") {
      ...
      dispatch({ type: "setFilterVal", val: ((_j2 = currentFilters[key]) == null ? void 0 : _j2.val) || "all" });
    }
    window.addEventListener(
      "keyup",
      (event) => {
  ...
  ), state.filterObj.keyType && (((_m = currentFilters[key]) == null ? void 0 : _m.op) || state.filterObj.filterOp) && /* @__PURE__ */ React.createElement(
    SortMenu,
    {
      className: "ml-s",
      items: state.filterObj.keyType === "date" && dateOp || state.filterObj.keyType === "number" && numericOp || state.filterObj.keyType === "string" && stringOp || state.filterObj.keyType === "lang" && langOp || state.filterObj.keyType === "menu" && menuOp,
      name: "filter_ops",
      defaultAccept: true,
      autoClose: true,
...
function ModuleViewHeaderBottom({ slug, noImport, noInsert, noExport, noCount, noDelete, header, table, insertOptions, activatePanel, detailsOptions, exportOptions, rowsSelected, defaultSortBy, onSort, onFilter, onClearRow }) {
  var _a;
  const { __ } = useI18n();
  const queryClient = useQueryClient();
