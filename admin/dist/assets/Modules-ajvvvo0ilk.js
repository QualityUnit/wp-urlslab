import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-ajvvvo0ilk.js";
import { S as Switch } from "./Switch-ajvvvo0ilk.js";
import { S as SvgApiExclamation } from "./api-exclamation-ajvvvo0ilk.js";
import { u as useMutation } from "./useMutation-ajvvvo0ilk.js";
const __vite_glob_0_0 = "" + new URL("optimize-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-ajvvvo0ilk.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-ajvvvo0ilk.png", import.meta.url).href;
