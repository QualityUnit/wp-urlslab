import { a as useQueryClient, r as reactExports, R as React, p as parseURL, b as setSettings, u as useI18n, c as useQuery, L as Loader, f as fetchSettings } from "../main-wkxjxa57v3.js";
import { F as FilterMenu, S as SortMenu, H as Ht, I as InputField, T as Tooltip } from "./Tooltip-wkxjxa57v3.js";
...
function Settings({ className, settingId }) {
  ...
  const renderStatus = () => {
    switch (tooltipStatus) {
      case "active":
        return /* @__PURE__ */ React.createElement(Tooltip, { className: "fixedBottom" }, __("Writing setting"));
      case "success":
        return /* @__PURE__ */ React.createElement(Tooltip, { className: "fixedBottom successStatus" }, __("Setting written!"));
      case "error":
        return /* @__PURE__ */ React.createElement(Tooltip, { className: "fixedBottom errorStatus" }, __("Failed! Try again please."));
    }
  };
