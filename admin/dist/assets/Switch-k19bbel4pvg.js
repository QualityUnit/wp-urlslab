import { r as reactExports, R as React } from "../main-k19bbel4pvg.js";
...
const _Switch = "";
function Switch({ id, textAfter, className, style, secondary, onChange, group, checked, label, labelOff }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    /* @__PURE__ */ React.createElement("span", { className: "urlslab-switch-text" }, !isChecked ? label : labelOff ? labelOff : label)
  );
}
export {
  Switch as S
