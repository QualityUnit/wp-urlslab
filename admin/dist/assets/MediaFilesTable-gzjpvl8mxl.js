import { r as reactExports, R as React, T as Tooltip, L as Loader } from "../main-gzjpvl8mxl.js";
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table, P as ProgressBar } from "./useTableUpdater-gzjpvl8mxl.js";
...
/* empty css                       */import { C as Checkbox, S as SortMenu } from "./FilterMenu-gzjpvl8mxl.js";
import { S as SvgIconLink } from "./icon-link-gzjpvl8mxl.js";
...
function MediaFilesTable({ slug }) {
  ...
  const columns = [
    ...
    columnHelper == null ? void 0 : columnHelper.accessor("driver", {
      ...
      className: "nolimit",
      cell: (cell) => /* @__PURE__ */ React.createElement(SortMenu, { items: driverTypes, name: cell.column.id, checkedId: cell.getValue(), onChange: (newVal) => updateRow({ newVal, customEndpoint: "/transfer", cell }) }),
