import { Q as QueryObserver, j as infiniteQueryBehavior, k as hasNextPage, m as hasPreviousPage, n as parseQueryArgs, o as useBaseQuery, R as React, r as reactExports, u as useI18n, f as fetchData, h as getParamsChar, L as Loader, a as useQueryClient, l as langName, q as get, t as update, B as Button, v as setData, i as commonjsGlobal, H as HeaderHeightContext, w as useResizeObserver, d as useQuery } from "../main-hk0merw2e9j.js";
import { T as Tooltip, S as SortMenu, I as InputField, F as FilterMenu, C as Checkbox, H as Ht } from "./Tooltip-hk0merw2e9j.js";
import { u as useMutation } from "./useMutation-hk0merw2e9j.js";
...
function useChangeRow({ data, url, slug, pageId }) {
  ...
  const updateRowData = useMutation({
    mutationFn: async (options) => {
      ...
      if (changeField) {
        const response2 = await setData(`${slug}/${getRowId(cell, optionalSelector)}`, { [changeField]: newVal });
        return response2;
      }
