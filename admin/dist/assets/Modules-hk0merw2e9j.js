import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-hk0merw2e9j.js";
import { S as Switch } from "./Switch-hk0merw2e9j.js";
import { S as SvgApiExclamation } from "./api-exclamation-hk0merw2e9j.js";
import { u as useMutation } from "./useMutation-hk0merw2e9j.js";
const __vite_glob_0_0 = "" + new URL("optimize-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-hk0merw2e9j.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-hk0merw2e9j.png", import.meta.url).href;
