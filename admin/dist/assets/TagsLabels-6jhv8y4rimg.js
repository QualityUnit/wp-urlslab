import { R as React, r as reactExports, u as useI18n, B as Button, a as useQueryClient, h as hexToHSL, g as Tag, T as Tooltip, L as Loader } from "../main-6jhv8y4rimg.js";
import { u as useTableUpdater, a as useInfiniteFetch, b as useChangeRow, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table } from "./useTableUpdater-6jhv8y4rimg.js";
import { u as useClickOutside } from "./_ColumnsMenu-6jhv8y4rimg.js";
/* empty css                        */import { I as InputField, C as Checkbox, F as FilterMenu } from "./FilterMenu-6jhv8y4rimg.js";
/* empty css                               */import "./useMutation-6jhv8y4rimg.js";
function u() {
...
const _ColorPicker = "";
function ColorPicker({ defaultColor, label, className, onChange }) {
  const { __ } = useI18n();
...
function TagsLabels() {
  ...
  const inserterCells = {
    name: /* @__PURE__ */ React.createElement(InputField, { liveUpdate: true, defaultValue: "", label: header.name, onChange: (val) => setInsertRow({ ...rowToInsert, name: val }), required: true }),
    bgcolor: /* @__PURE__ */ React.createElement(ColorPicker, { defaultValue: "", label: "Background color", onChange: (val) => setInsertRow({ ...rowToInsert, bgcolor: val }) }),
    modules: /* @__PURE__ */ React.createElement(FilterMenu, { liveUpdate: true, asTags: true, id: "modules", items: possibleModules, checkedItems: [], onChange: (val) => setInsertRow({ ...rowToInsert, modules: val }) }, header.modules)
  };
  const columns = [
    ...
    columnHelper.accessor("name", {
      ...
      cell: (cell) => {
        ...
        return /* @__PURE__ */ React.createElement(Tag, { fullSize: true, className: lightness < 70 ? "dark" : "", style: { backgroundColor: cell.row.original.bgcolor } }, cell.getValue());
      },
      header: "Tags",
      size: 150
    }),
    columnHelper.accessor("modules", {
      ...
      cell: (cell) => /* @__PURE__ */ React.createElement(
        FilterMenu,
        {
          ...
          asTags: true,
          id: "modules",
          checkedItems: (cell == null ? void 0 : cell.getValue()[0]) && (cell == null ? void 0 : cell.getValue()) || [],
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "urlslab-tableView" }, /* @__PURE__ */ React.createElement(
    ...
    rowToInsert === "rowInserted" ? /* @__PURE__ */ React.createElement(Tooltip, { center: true }, __("Tag has been added.")) : null
  ));
}
export {
