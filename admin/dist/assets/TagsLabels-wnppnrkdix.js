<<<<<<< HEAD:admin/dist/assets/TagsLabels-6ohoyviu4u.js
<<<<<<< HEAD:admin/dist/assets/TagsLabels-myg4akepfo.js
...
=======
import { R as React, r as reactExports, u as useI18n, B as Button, a as useQueryClient, j as hexToHSL, T as Tag, L as Loader } from "../main-6ohoyviu4u.js";
import { u as useClickOutside, a as useTableUpdater, b as useInfiniteFetch, c as useChangeRow, I as IconButton, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table } from "./ModuleViewHeaderBottom-6ohoyviu4u.js";
import { C as Checkbox, M as MultiSelectMenu } from "./MultiSelectMenu-6ohoyviu4u.js";
import { I as InputField } from "./datepicker-6ohoyviu4u.js";
import { S as SvgIconEdit } from "./icon-edit-6ohoyviu4u.js";
>>>>>>> 18bd270e (custom vite build & watch):admin/dist/assets/TagsLabels-6ohoyviu4u.js
=======
import { R as React, r as reactExports, u as useI18n, B as Button, a as useQueryClient, j as hexToHSL, T as Tag, L as Loader } from "../main-wnppnrkdix.js";
import { u as useClickOutside, a as useTableUpdater, b as useInfiniteFetch, c as useChangeRow, I as IconButton, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table } from "./ModuleViewHeaderBottom-wnppnrkdix.js";
import { C as Checkbox, M as MultiSelectMenu } from "./MultiSelectMenu-wnppnrkdix.js";
import { I as InputField } from "./datepicker-wnppnrkdix.js";
import { S as SvgIconEdit } from "./icon-edit-wnppnrkdix.js";
>>>>>>> 63c8f541 (feat: add popup content):admin/dist/assets/TagsLabels-wnppnrkdix.js
...
function TagsLabels() {
  ...
  const rowEditorCells = {
    name: /* @__PURE__ */ React.createElement(InputField, { liveUpdate: true, defaultValue: "", label: header.name, onChange: (val) => setRowToEdit({ ...rowToEdit, name: val }), required: true }),
    bgcolor: /* @__PURE__ */ React.createElement(ColorPicker, { defaultValue: "", label: "Background color", onChange: (val) => setRowToEdit({ ...rowToEdit, bgcolor: val }) }),
    modules: /* @__PURE__ */ React.createElement(MultiSelectMenu, { liveUpdate: true, asTags: true, id: "modules", items: possibleModules, defaultValue: [], onChange: (val) => setRowToEdit({ ...rowToEdit, modules: val }) }, header.modules)
  };
  const columns = [
