import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule } from "../main-uwauh9ai4e.js";
import { S as Switch } from "./Switch-uwauh9ai4e.js";
import { S as SvgApiExclamation } from "./api-exclamation-uwauh9ai4e.js";
import { u as useMutation } from "./useMutation-uwauh9ai4e.js";
const __vite_glob_0_0 = "" + new URL("optimize-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-uwauh9ai4e.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-uwauh9ai4e.png", import.meta.url).href;
