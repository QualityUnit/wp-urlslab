import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-detblgjz19.js";
import { S as Switch } from "./Switch-detblgjz19.js";
import { S as SvgApiExclamation } from "./api-exclamation-detblgjz19.js";
import { u as useMutation } from "./useMutation-detblgjz19.js";
const __vite_glob_0_0 = "" + new URL("optimize-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-detblgjz19.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-detblgjz19.png", import.meta.url).href;
