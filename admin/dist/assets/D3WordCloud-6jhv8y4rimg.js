import { j as getAugmentedNamespace, r as reactExports, a as useQueryClient, d as useQuery, R as React, f as fetchData, k as getParamsChar } from "../main-6jhv8y4rimg.js";
import "./ModuleViewHeader-6jhv8y4rimg.js";
import "./api-exclamation-6jhv8y4rimg.js";
...
var d3Cloud = function() {
  var size = [256, 256], text = cloudText, font = cloudFont, fontSize = cloudFontSize, fontStyle = cloudFontNormal, fontWeight = cloudFontNormal, rotate = cloudRotate, padding = cloudPadding, spiral = archimedeanSpiral, words = [], timeInterval = Infinity, event = dispatch("word", "end"), timer2 = null, random = Math.random, cloud = {}, canvas = cloudCanvas;
...
const D3WordCloud = ({ slug }) => {
  ...
  const { data } = useQuery({
    ...
    queryFn: () => fetchData(`${slug}` + getParamsChar() + `filter_kw_usage_count=%7B%22op%22%3A%22%3E%22%2C%22val%22%3A0%7D${filters !== void 0 ? filters : ""}&sort_column=kw_usage_count&sort_direction=DESC&rows_per_page=1000`).then((chartData) => {
      return chartData;
    }),
