import { R as React, L as Loader, i as Tooltip } from "../main-mhel6gbjl1.js";
import { a as useTableUpdater, b as useInfiniteFetch, c as useChangeRow, d as SortBy, I as IconButton, S as SvgIconTrash, M as ModuleViewHeaderBottom, T as Table, P as ProgressBar } from "./ModuleViewHeaderBottom-mhel6gbjl1.js";
...
function RedirectsTable({ slug }) {
  ...
  const rowEditorCells = {
    ...
    replace_url: /* @__PURE__ */ React.createElement(SuggestInputField, { suggestInput: (rowToEdit == null ? void 0 : rowToEdit.match_url) || "", liveUpdate: true, defaultValue: "", label: header.replace_url, onChange: (val) => setEditorRow({ ...rowToEdit, replace_url: val }), required: true }),
    ...
    params: /* @__PURE__ */ React.createElement(InputField, { liveUpdate: true, defaultValue: "", label: header.params, onChange: (val) => setEditorRow({ ...rowToEdit, params: val }) }),
