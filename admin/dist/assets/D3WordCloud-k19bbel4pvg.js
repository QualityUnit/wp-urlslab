import { g as getAugmentedNamespace, r as reactExports, a as useQueryClient, e as useQuery, R as React, h as fetchData } from "../main-k19bbel4pvg.js";
...
const D3WordCloud = ({ slug, children: children2 }) => {
  ...
  const { data } = useQuery({
    ...
    queryFn: () => fetchData(`${slug}?filter_kw_usage_count=%7B%22op%22%3A%22%3E%22%2C%22val%22%3A0%7D${filters !== void 0 ? filters : ""}&sort_column=kw_usage_count&sort_direction=DESC&rows_per_page=1000`).then((chartData) => {
      return chartData;
    }),
