import { r as reactExports, R as React, i as delay, T as Tooltip, L as Loader } from "../main-i2quehqn9g.js";
...
import { D as DateTimeFormat } from "./DateTimeFormat-i2quehqn9g.js";
...
import { S as SvgIconActivate, a as SvgIconDisable } from "./icon-disable-i2quehqn9g.js";
...
function GeneratorShortcodeTable({ slug }) {
  ...
  const rowEditorCells = {
    shortcode_type: /* @__PURE__ */ React.createElement(
      ...
      {
        autoClose: true,
        description: __("In case of video context type, Semantic search query should contain youtube videoid."),
    ...
    template: /* @__PURE__ */ React.createElement(TextArea, { rows: "5", liveUpdate: true, description: supported_variables_description, defaultValue: "", label: header.template, onChange: (val) => setEditorRow({ ...rowToEdit, template: val }), required: true }),
