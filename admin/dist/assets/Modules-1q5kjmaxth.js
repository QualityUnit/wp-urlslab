import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-1q5kjmaxth.js";
import { S as Switch } from "./Switch-1q5kjmaxth.js";
import { S as SvgApiExclamation } from "./api-exclamation-1q5kjmaxth.js";
import { u as useMutation } from "./useMutation-1q5kjmaxth.js";
const __vite_glob_0_0 = "" + new URL("optimize-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-1q5kjmaxth.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-1q5kjmaxth.png", import.meta.url).href;
