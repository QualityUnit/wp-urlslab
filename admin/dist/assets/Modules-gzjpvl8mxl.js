import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-gzjpvl8mxl.js";
import { S as Switch } from "./Switch-gzjpvl8mxl.js";
import { S as SvgApiExclamation } from "./api-exclamation-gzjpvl8mxl.js";
import { u as useMutation } from "./useMutation-gzjpvl8mxl.js";
const __vite_glob_0_0 = "" + new URL("optimize-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-gzjpvl8mxl.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-gzjpvl8mxl.png", import.meta.url).href;
