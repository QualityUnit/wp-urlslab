import { r as reactExports, u as useI18n, a as useQueryClient, R as React, s as setModule, b as useCheckApiKey } from "../main-bnkd71mu9.js";
import { S as Switch } from "./Switch-bnkd71mu9.js";
import { S as SvgApiExclamation } from "./api-exclamation-bnkd71mu9.js";
import { u as useMutation } from "./useMutation-bnkd71mu9.js";
const __vite_glob_0_0 = "" + new URL("optimize-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_1 = "" + new URL("urlslab-css-optimizer-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_2 = "" + new URL("urlslab-image-alt-attribute-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_3 = "" + new URL("urlslab-keywords-links-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_4 = "" + new URL("urlslab-lazy-loading-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_5 = "" + new URL("urlslab-link-enhancer-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_6 = "" + new URL("urlslab-media-offloader-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_7 = "" + new URL("urlslab-meta-tag-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_8 = "" + new URL("urlslab-related-resources-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_9 = "" + new URL("urlslab-screenshot-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_10 = "" + new URL("urlslab-search-and-replace-bnkd71mu9.png", import.meta.url).href;
const __vite_glob_0_11 = "" + new URL("yt_lazy_loading-bnkd71mu9.png", import.meta.url).href;
