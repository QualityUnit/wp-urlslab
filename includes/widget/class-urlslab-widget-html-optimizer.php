...
class Urlslab_Widget_Html_Optimizer extends Urlslab_Widget {
	...
	protected function add_options() {
		...
		$this->add_option_definition(
			...
			true,
			__( 'HTML Minification', 'urlslab' ),
			__( 'Enable HTML Minification.', 'urlslab' ),
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Optimize Attributes', 'urlslab' ),
			__( 'Delete attributes that have a default or empty value.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'minify'
		...
		$this->add_option_definition(
			...
			true,
			true,
			__( 'Remove Comments', 'urlslab' ),
			__( 'Remove HTML comments. Often, comments are unused and merely create additional network traffic with every request.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'minify'
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Remove Whitespaces', 'urlslab' ),
			__( 'Remove spaces in and around tags.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'minify'
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Remove Deprecated', 'urlslab' ),
			__( 'Remove deprecated anchor names, script character set, and type from script tags. Also, remove type from stylesheet links.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'minify'
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Remove Omitted', 'urlslab' ),
			__( 'Remove omitted quotes and HTML tags.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'minify'
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Remove Prefix From Attributes', 'urlslab' ),
			__( 'Shorten links by eliminating protocols and adopting the relative protocol from the current page.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'minify'
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Sort Classes and Attributes', 'urlslab' ),
			__( 'Improved GZIP compression can be achieved for strings if multiple tags use the same class name or attribute order.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'minify'
		...
		$this->add_options_form_section(
			'css',
			__( 'CSS Minification', 'urlslab' ),
			__( 'Improving your website\'s speed is essential and can be accomplished by optimizing resources like CSS files. Configuring these files with a specific size limit and expiry date improves your website\'s performance and loading speed.', 'urlslab' ),
			array(
				self::LABEL_FREE,
			)
		);
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Process CSS files', 'urlslab' ),
			__( 'Download CSS files, saves them to the database, and enhances for optimal performance.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'css'
		...
		$this->add_option_definition(
			...
			2592000,
			true,
			__( 'CSS Cache Expiration', 'urlslab' ),
			__( 'Specify the duration for storing the CSS file in the database.', 'urlslab' ),
		...
		$this->add_option_definition(
			...
			0,
			true,
			__( 'CSS Cache Valid From', 'urlslab' ),
			__( 'CSS Cache valid from', 'urlslab' ),
		...
		$this->add_option_definition(
			...
			350000,
			true,
			__( 'Convert Small CSS Files Into Inline HTML (bytes)', 'urlslab' ),
			__( 'Set a size limit for the CSS file that loads into the HTML content. If you don\'t want any CSS file to be included in the main HTML, set this to 0.', 'urlslab' ),
		...
		$this->add_option_definition(
			...
			true,
			__( 'CSS Minification', 'urlslab' ),
			__( 'Minify CSS files by eliminating whitespace, deleting comments and refining/abbreviating some common coding patterns.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'css'
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Merge CSS', 'urlslab' ),
			__( 'Merge all CSS files used on the page into a single file.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'css'
		...
		$this->add_options_form_section(
			'js',
			__( 'Javascript Minification', 'urlslab' ),
			__( 'Improving your website\'s speed is essential and can be accomplished by optimizing resources like JavaScript files. Configuring these files with a specific size limit and expiry date improves your website\'s performance and loading speed.', 'urlslab' ),
			array(
				self::LABEL_FREE,
			)
		);
		...
		$this->add_option_definition(
			...
			false,
			true,
			__( 'Javascript Processing', 'urlslab' ),
			__( 'Download JavaScript files, saves them to the database, and enhances for optimal performance.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'js'
		...
		$this->add_option_definition(
			...
			0,
			true,
			__( 'JavaScript Cache Valid From', 'urlslab' ),
			__( 'JavaScript Cache Valid From', 'urlslab' ),
			self::OPTION_TYPE_HIDDEN,
			false,
			null,
		...
		$this->add_option_definition(
			...
			2592000,
			true,
			__( 'JavaScript Cache Expiration', 'urlslab' ),
			__( 'Specify the duration for storing the JavaScript file in the database.', 'urlslab' ),
			self::OPTION_TYPE_LISTBOX,
			array(
				3600     => __( 'One hour', 'urlslab' ),
				28800    => __( 'Eight hours', 'urlslab' ),
		...
		$this->add_option_definition(
			...
			0,
			true,
			__( 'Convert Small JavaScript Files Into Inline HTML (bytes)', 'urlslab' ),
			__( 'Set a size limit for the JavaScript file that loads into the HTML content. If you don\'t want any JavaScript file to be included in the main HTML, set this to 0.', 'urlslab' ),
			self::OPTION_TYPE_NUMBER,
			false,
			function( $value ) {
				return is_numeric( $value ) && 0 <= $value;
		...
		$this->add_option_definition(
			...
			true,
			__( 'JavaScript Minification', 'urlslab' ),
			__( 'Minify JavaScript files by eliminating whitespace, deleting comments and refining/abbreviating some common coding patterns.', 'urlslab' ),
			self::OPTION_TYPE_CHECKBOX,
			false,
			null,
			'js'
