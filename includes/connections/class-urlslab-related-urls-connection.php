...
class Urlslab_Related_Urls_Connection {
	private static Urlslab_Related_Urls_Connection $instance;
	private static ContentApi $content_client;

	public static function get_instance(): Urlslab_Related_Urls_Connection {
	...
	public function get_related_urls_to_url( Urlslab_Url_Row $url, int $max_count, string $str_domains, int $not_older_than ) {
