...
class Urlslab_Lazy_Loading extends Urlslab_Widget {
	...
	protected function add_options() {
		...
		$this->add_option_definition(
			...
			0,
			false,
			__( 'Attach Generator To Youtube each videos' ),
			__( 'Attach next to each video additional information generated by AI. Input value should be Generator short code id already defined in AI content generators. Imagination is limitless, one of the usecase could be to attach next to video summarization of video transcript, or full transcript.' ),
