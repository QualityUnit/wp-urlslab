...
class Urlslab_Data_File_Pointer extends Urlslab_Data {
	/**
	...
	public function get_driver_object(): Urlslab_Driver {
		if ( empty( $this->get_driver() ) ) {
			$this->set_driver( Urlslab_User_Widget::get_instance()->get_widget( Urlslab_Widget_Media_Offloader::SLUG )->get_option( Urlslab_Widget_Media_Offloader::SETTING_NAME_NEW_FILE_DRIVER ) );
		}
