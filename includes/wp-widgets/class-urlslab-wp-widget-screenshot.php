...
class Urlslab_Wp_Widget_Screenshot extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo Urlslab_User_Widget::get_instance()->get_widget( Urlslab_Screenshot_Widget::SLUG )->get_shortcode_content( $instance );
	}
	...
	private function print_form_field( $instance, $field_name, $field_label ) {
		?>
		<p>
			<label for="<?php echo $this->get_field_id( $field_name ); ?>"><?php echo $field_label ?></label>
