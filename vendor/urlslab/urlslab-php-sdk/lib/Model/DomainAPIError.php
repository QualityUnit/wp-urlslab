 ...
 */
class DomainAPIError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'domain.APIError';
    ...
    public const ERROR_TYPE_MALFORMED_REQUEST = 'MALFORMED_REQUEST';
    public const ERROR_TYPE_UNAUTHORIZED = 'UNAUTHORIZED';
    public const ERROR_TYPE_ERROR = 'ERROR';
    public const ERROR_TYPE_INVALID_API_KEY = 'INVALID_API_KEY';
    public const ERROR_TYPE_NOT_FOUND = 'NOT_FOUND';
    public const ERROR_TYPE_FORBIDDEN = 'FORBIDDEN';
    public const ERROR_TYPE_NOT_ENOUGH_CREDIT = 'NOT_ENOUGH_CREDIT';
