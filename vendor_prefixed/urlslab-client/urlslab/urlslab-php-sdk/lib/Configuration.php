...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.urlslab.com';
    /**
     * User agent of the HTTP request, set to "OpenAPI-Generator/{version}/PHP" by default
     *
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/0.1.58/PHP';
    /**
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    SDK Package Version: 0.1.58' . \PHP_EOL;
    ...
    {
        return [["url" => "https://api.urlslab.com", "description" => "Production server"], ["url" => "http://localhost:9000", "description" => "Local server"]];
    }
    /**
