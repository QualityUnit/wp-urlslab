...
class DomainDataRetrievalScreenshotResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['domain_id' => 'string', 'url_id' => 'string', 'url' => 'string', 'redirected_to' => 'string', 'screenshot_id' => 'int', 'url_title' => 'string', 'url_meta_description' => 'string', 'screenshot_status' => 'string'];
    /**
     ...
     */
    protected static $openAPIFormats = ['domain_id' => null, 'url_id' => null, 'url' => null, 'redirected_to' => null, 'screenshot_id' => 'int64', 'url_title' => null, 'url_meta_description' => null, 'screenshot_status' => null];
    /**
     * Array of nullable properties. Used for (de)serialization
     *
     * @var boolean[]
     */
    protected static array $openAPINullables = ['domain_id' => \false, 'url_id' => \false, 'url' => \false, 'redirected_to' => \true, 'screenshot_id' => \true, 'url_title' => \true, 'url_meta_description' => \true, 'screenshot_status' => \false];
    /**
     ...
     * @var string[]
     */
    protected static $attributeMap = ['domain_id' => 'domainId', 'url_id' => 'urlId', 'url' => 'url', 'redirected_to' => 'redirectedTo', 'screenshot_id' => 'screenshotID', 'url_title' => 'urlTitle', 'url_meta_description' => 'urlMetaDescription', 'screenshot_status' => 'screenshotStatus'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['domain_id' => 'setDomainId', 'url_id' => 'setUrlId', 'url' => 'setUrl', 'redirected_to' => 'setRedirectedTo', 'screenshot_id' => 'setScreenshotId', 'url_title' => 'setUrlTitle', 'url_meta_description' => 'setUrlMetaDescription', 'screenshot_status' => 'setScreenshotStatus'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['domain_id' => 'getDomainId', 'url_id' => 'getUrlId', 'url' => 'getUrl', 'redirected_to' => 'getRedirectedTo', 'screenshot_id' => 'getScreenshotId', 'url_title' => 'getUrlTitle', 'url_meta_description' => 'getUrlMetaDescription', 'screenshot_status' => 'getScreenshotStatus'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    {
        return [self::SCREENSHOT_STATUS_ERROR, self::SCREENSHOT_STATUS_PENDING, self::SCREENSHOT_STATUS_REDIRECTED, self::SCREENSHOT_STATUS_BLOCKED, self::SCREENSHOT_STATUS_UPDATING, self::SCREENSHOT_STATUS_AVAILABLE];
    }
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if (!\is_null($this->container['screenshot_status']) && !\in_array($this->container['screenshot_status'], $allowedValues, \true)) {
            $invalidProperties[] = \sprintf("invalid value '%s' for 'screenshot_status', must be one of '%s'", $this->container['screenshot_status'], \implode("', '", $allowedValues));
        }
    ...
    public function setScreenshotStatus($screenshot_status)
    {
        ...
        $allowedValues = $this->getScreenshotStatusAllowableValues();
        if (!\in_array($screenshot_status, $allowedValues, \true)) {
            throw new \InvalidArgumentException(\sprintf("Invalid value '%s' for 'screenshot_status', must be one of '%s'", $screenshot_status, \implode("', '", $allowedValues)));
        }
