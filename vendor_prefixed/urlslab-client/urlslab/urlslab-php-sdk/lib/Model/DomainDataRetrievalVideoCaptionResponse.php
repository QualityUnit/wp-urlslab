...
class DomainDataRetrievalVideoCaptionResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['transcript' => 'string', 'status' => 'string', 'message' => 'string'];
    /**
     ...
     */
    protected static $openAPIFormats = ['transcript' => null, 'status' => null, 'message' => null];
    /**
     * Array of nullable properties. Used for (de)serialization
     *
     * @var boolean[]
     */
    protected static array $openAPINullables = ['transcript' => \true, 'status' => \false, 'message' => \true];
    /**
     ...
     * @var string[]
     */
    protected static $attributeMap = ['transcript' => 'transcript', 'status' => 'status', 'message' => 'message'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['transcript' => 'setTranscript', 'status' => 'setStatus', 'message' => 'setMessage'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['transcript' => 'getTranscript', 'status' => 'getStatus', 'message' => 'getMessage'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    {
        return [self::STATUS_ERROR, self::STATUS_PENDING, self::STATUS_REDIRECTED, self::STATUS_BLOCKED, self::STATUS_UPDATING, self::STATUS_AVAILABLE];
    }
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if (!\is_null($this->container['status']) && !\in_array($this->container['status'], $allowedValues, \true)) {
            $invalidProperties[] = \sprintf("invalid value '%s' for 'status', must be one of '%s'", $this->container['status'], \implode("', '", $allowedValues));
        }
