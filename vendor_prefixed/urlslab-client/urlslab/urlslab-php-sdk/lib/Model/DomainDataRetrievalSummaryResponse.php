...
class DomainDataRetrievalSummaryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string[]
     */
    protected static $openAPITypes = ['domain_id' => 'string', 'url_id' => 'string', 'url' => 'string', 'redirected_to' => 'string', 'summary' => 'string', 'summary_status' => 'string'];
    /**
     ...
     */
    protected static $openAPIFormats = ['domain_id' => null, 'url_id' => null, 'url' => null, 'redirected_to' => null, 'summary' => null, 'summary_status' => null];
    /**
     * Array of nullable properties. Used for (de)serialization
     *
     * @var boolean[]
     */
    protected static array $openAPINullables = ['domain_id' => \false, 'url_id' => \false, 'url' => \false, 'redirected_to' => \true, 'summary' => \true, 'summary_status' => \false];
    /**
     ...
     * @var string[]
     */
    protected static $attributeMap = ['domain_id' => 'domainId', 'url_id' => 'urlId', 'url' => 'url', 'redirected_to' => 'redirectedTo', 'summary' => 'summary', 'summary_status' => 'summaryStatus'];
    /**
     * Array of attributes to setter functions (for deserialization of responses)
     *
     * @var string[]
     */
    protected static $setters = ['domain_id' => 'setDomainId', 'url_id' => 'setUrlId', 'url' => 'setUrl', 'redirected_to' => 'setRedirectedTo', 'summary' => 'setSummary', 'summary_status' => 'setSummaryStatus'];
    /**
     * Array of attributes to getter functions (for serialization of requests)
     *
     * @var string[]
     */
    protected static $getters = ['domain_id' => 'getDomainId', 'url_id' => 'getUrlId', 'url' => 'getUrl', 'redirected_to' => 'getRedirectedTo', 'summary' => 'getSummary', 'summary_status' => 'getSummaryStatus'];
    /**
     * Array of attributes where the key is the local name,
     * and the value is the original name
     *
    ...
    {
        return [self::SUMMARY_STATUS_ERROR, self::SUMMARY_STATUS_PENDING, self::SUMMARY_STATUS_REDIRECTED, self::SUMMARY_STATUS_BLOCKED, self::SUMMARY_STATUS_UPDATING, self::SUMMARY_STATUS_AVAILABLE];
    }
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if (!\is_null($this->container['summary_status']) && !\in_array($this->container['summary_status'], $allowedValues, \true)) {
            $invalidProperties[] = \sprintf("invalid value '%s' for 'summary_status', must be one of '%s'", $this->container['summary_status'], \implode("', '", $allowedValues));
        }
    ...
    public function setSummaryStatus($summary_status)
    {
        ...
        $allowedValues = $this->getSummaryStatusAllowableValues();
        if (!\in_array($summary_status, $allowedValues, \true)) {
            throw new \InvalidArgumentException(\sprintf("Invalid value '%s' for 'summary_status', must be one of '%s'", $summary_status, \implode("', '", $allowedValues)));
        }
