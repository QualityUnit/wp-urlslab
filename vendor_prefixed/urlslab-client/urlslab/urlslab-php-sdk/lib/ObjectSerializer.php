 ...
 */
namespace Urlslab_Vendor\OpenAPI\Client;

use Urlslab_Vendor\GuzzleHttp\Psr7\Utils;
use Urlslab_Vendor\OpenAPI\Client\Model\ModelInterface;
/**
...
class ObjectSerializer
{
        ...
        if (\is_object($data)) {
            ...
            if ($data instanceof ModelInterface) {
                ...
                foreach ($data::openAPITypes() as $property => $openAPIType) {
                    ...
                    $value = $data->{$getter}();
                    if ($value !== null && !\in_array($openAPIType, ['\\DateTime', '\\SplFileObject', 'array', 'bool', 'boolean', 'byte', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], \true)) {
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (\in_array($class, ['\\DateTime', '\\SplFileObject', 'array', 'bool', 'boolean', 'byte', 'float', 'int', 'integer', 'mixed', 'number', 'object', 'string', 'void'], \true)) {
            \settype($data, $class);
            return $data;
        }
    ...
    {
        return \Urlslab_Vendor\GuzzleHttp\Psr7\Query::build($data, $encoding_type);
    }
}
