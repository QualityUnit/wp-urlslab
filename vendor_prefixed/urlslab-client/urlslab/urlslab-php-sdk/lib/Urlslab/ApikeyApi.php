...
class ApikeyApi
{
    ...
    public const contentTypes = ['createAPIKey' => ['text/plain'], 'deleteAPIKey' => ['text/plain'], 'listAPIKey' => ['text/plain'], 'validate' => ['text/plain']];
    /**
    ...
    {
        return $this->createAPIKeyAsyncWithHttpInfo($body, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->deleteAPIKeyAsyncWithHttpInfo($body, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->listAPIKeyAsyncWithHttpInfo($body, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    {
        return $this->validateAsyncWithHttpInfo($body, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
