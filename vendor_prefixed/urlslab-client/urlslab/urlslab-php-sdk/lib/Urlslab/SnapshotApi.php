...
class SnapshotApi
{
    ...
    public const contentTypes = ['getSnapshots' => ['application/json'], 'getSnapshotsHistory' => ['text/plain']];
    /**
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, '\\OpenAPI\\Client\\Model\\DomainDataRetrievalScreenshotResponse[]', []), $response->getStatusCode(), $response->getHeaders()];
            }
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), '\\OpenAPI\\Client\\Model\\DomainDataRetrievalScreenshotResponse[]', $e->getResponseHeaders());
    ...
    {
        return $this->getSnapshotsAsyncWithHttpInfo($domain_data_retrieval_data_request, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getSnapshotsRequest($domain_data_retrieval_data_request, string $contentType = self::contentTypes['getSnapshots'][0])
    {
        ...
        if ($domain_data_retrieval_data_request === null || \is_array($domain_data_retrieval_data_request) && \count($domain_data_retrieval_data_request) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $domain_data_retrieval_data_request when calling getSnapshots');
        }
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalUrlSnapshotMultiResponse', []), $response->getStatusCode(), $response->getHeaders()];
            }
            $returnType = 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalUrlSnapshotMultiResponse';
            if ($returnType === '\\SplFileObject') {
                $content = $response->getBody();
                //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalUrlSnapshotMultiResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getSnapshotsHistoryAsyncWithHttpInfo($url, $last_id, $last_timestamp, $limit, $body, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getSnapshotsHistoryRequest($url, $last_id = null, $last_timestamp = null, $limit = null, $body = null, string $contentType = self::contentTypes['getSnapshotsHistory'][0])
    {
        ...
        if ($url === null || \is_array($url) && \count($url) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $url when calling getSnapshotsHistory');
        }
