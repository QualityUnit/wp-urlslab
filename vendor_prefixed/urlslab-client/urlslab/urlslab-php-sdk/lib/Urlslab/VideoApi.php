...
class VideoApi
{
    ...
    public const contentTypes = ['getYTMicrodata' => ['text/plain'], 'getYTVidCaption' => ['text/plain']];
    /**
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalVideoResponse', []), $response->getStatusCode(), $response->getHeaders()];
            }
            $returnType = 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalVideoResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalVideoResponse', $e->getResponseHeaders());
    ...
    {
        return $this->getYTMicrodataAsyncWithHttpInfo($yt_vid_id, $body, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getYTMicrodataRequest($yt_vid_id, $body = null, string $contentType = self::contentTypes['getYTMicrodata'][0])
    {
        ...
        if ($yt_vid_id === null || \is_array($yt_vid_id) && \count($yt_vid_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $yt_vid_id when calling getYTMicrodata');
        }
        ...
        // path params
        if ($yt_vid_id !== null) {
            $resourcePath = \str_replace('{' . 'ytVidId' . '}', ObjectSerializer::toPathValue($yt_vid_id), $resourcePath);
        }
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [ObjectSerializer::deserialize($content, 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalVideoCaptionResponse', []), $response->getStatusCode(), $response->getHeaders()];
            }
            $returnType = 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalVideoCaptionResponse';
            if ($returnType === '\\SplFileObject') {
                $content = $response->getBody();
                //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize($e->getResponseBody(), 'Urlslab_Vendor\\OpenAPI\\Client\\Model\\DomainDataRetrievalVideoCaptionResponse', $e->getResponseHeaders());
                    $e->setResponseObject($data);
                    break;
            }
            throw $e;
    ...
    {
        return $this->getYTVidCaptionAsyncWithHttpInfo($yt_vid_id, $body, $contentType)->then(function ($response) {
            return $response[0];
        });
    }
    /**
    ...
    public function getYTVidCaptionRequest($yt_vid_id, $body = null, string $contentType = self::contentTypes['getYTVidCaption'][0])
    {
        // verify the required parameter 'yt_vid_id' is set
        if ($yt_vid_id === null || \is_array($yt_vid_id) && \count($yt_vid_id) === 0) {
            throw new \InvalidArgumentException('Missing the required parameter $yt_vid_id when calling getYTVidCaption');
        }
