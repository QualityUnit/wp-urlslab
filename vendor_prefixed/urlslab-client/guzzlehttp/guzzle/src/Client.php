...
use Urlslab_Vendor\GuzzleHttp\Cookie\CookieJar;
use Urlslab_Vendor\GuzzleHttp\Exception\GuzzleException;
use Urlslab_Vendor\GuzzleHttp\Exception\InvalidArgumentException;
 ...
 * @final
 */
class Client implements ClientInterface, \Urlslab_Vendor\Psr\Http\Client\ClientInterface
{
    use ClientTrait;
    /**
